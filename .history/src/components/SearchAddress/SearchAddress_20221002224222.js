      ...
      <div className="lg:w-[60%] md:w-[80%] m-auto border-style:solid border-2 border-[#717273] rounded p-2">
        <div className="bg-[#fdedef] p-[32px] rounded w-[100%] m-auto">
          <input
            type="text"
            minLength="1"
            className="py-[12px] px-[8px] lg:w-[80%] md:w-[80%] outline-[#80bdff] text-[#495057] font-extrabold rounded-l-lg inputAddress lg:ml-[50px] md:ml-[50px] ml-[30px] block m-auto"
