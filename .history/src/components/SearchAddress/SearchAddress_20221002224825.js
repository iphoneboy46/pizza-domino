    ...
    <div id="address" className="search-address">
      <div className="w-[80%] m-auto flex justify-center items-center">
        <button
          className={
            activeBtn === 1
              ? "active mr-5 border-style:solid border-2 border-[#717273] py-[8px] lg:px-[32px] md:px-[32px] px-0 bg-wh1 text-white rounded-t-lg font-extrabold"
              : "mr-5 border-style:solid border-2 border-[#717273] py-[8px] lg:px-[32px] md:px-[32px] px-0 bg-wh1 text-white rounded-t-lg font-extrabold"
          }
          onClick={() => {
            handleActive1(1);
          }}
        ...
        <button
          className={
            activeBtn === 2
              ? "active border-style:solid border-2 border-[#717273] py-[8px] lg:px-[32px] md:px-[32px] px-0 bg-wh1 text-white rounded-t-lg font-extrabold btn-dl"
              : "border-style:solid border-2 border-[#717273] py-[8px] lg:px-[32px] md:px-[32px] px-0 bg-wh1 text-white rounded-t-lg font-extrabold btn-dl"
          }
          onClick={() => {
            handleActive2(2);
          }}
