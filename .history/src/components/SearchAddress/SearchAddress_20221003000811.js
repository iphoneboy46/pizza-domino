...
function SearchAddress() {
      ...
      <div className="lg:w-[60%] md:w-[80%] m-auto border-style:solid border-2 border-[#717273] rounded p-2">
        <div className="bg-[#fdedef] flex justify-center p-[32px] rounded w-[100%] m-auto">
          ...
          <Link
            ...
            className="bg-[#0078ae] opacity-[0.4] pointer-events-none py-[12px] px-[16px] text-white rounded-r-lg btnSubAddress"
          >
  ...
  function handleFocus() {
    const btnAd = document.getElementsByClassName("btnSubAddress");
    if (address.length > 0) {
      btnAd.style.pointerEvents = "active";
      btnAd.style.backgroundColor = "#0078ae";
