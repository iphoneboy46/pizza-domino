    ...
    <div id="address" className="search-address">
      ...
      <div className="lg:w-[50%] md:w-[90%] m-auto border-style:solid border-2 border-[#717273] rounded p-2">
        <div className="bg-[#fdedef] flex justify-center p-[32px] rounded w-[100%] m-auto">
         <div className="relative lg:w-[80%] md:w-[80%] overflow-hidden">
            <input
              type="text"
              value={address}
              ...
              ref={inputRef}
            />
            <div className="delete absolute right-[10px] top-[0px] hidden bg-yellowcustom p-3">
              <i onClick={handleClear} class="fa-solid fa-x text-xl text-[#686868]"></i>
            </div>
         </div>
          <button
