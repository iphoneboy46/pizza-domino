...
function SearchAddress() {
  ...
  return (
    <div id="address" className="search-address">
      ...
      <div className="w-[80%] m-auto border-style:solid border-2 border-[#717273] rounded p-2">
        <div className="bg-[#fdedef] p-[32px] rounded w-[100%] m-auto">
          <input
            type="text"
            minLength="1"
            className="py-[12px] px-[8px] lg:w-[80%] md:w-[60%] outline-[#80bdff] text-[#495057] font-extrabold rounded-l-lg inputAddress ml-[50px]"
          ...
          <Link
            ...
            className="bg-[#0078ae] opacity-[0.4] pointer-events-none py-[12px] px-[16px] text-white rounded-r-lg w-[20%]"
          >
