...
function SearchAddress() {
  ...
  return (
    <div id="address" className="search-address">
      ...
      <div className="lg:w-[50%] md:w-[80%] m-auto border-style:solid border-2 border-[#717273] rounded p-2">
        <div className="bg-[#fdedef] flex justify-center p-[32px] rounded w-[100%] m-auto">
          <input
            type="text"
            className="py-[12px] px-[8px] lg:w-[50%] md:w-[80%] outline-[#80bdff] text-[#495057] font-extrabold rounded-l-lg inputAddress"
