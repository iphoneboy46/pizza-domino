      ...
      <div className="lg:w-[50%] md:w-[90%] m-auto border-style:solid border-2 border-[#717273] rounded p-2">
        <div className="bg-[#fdedef] flex justify-center p-[32px] rounded w-[100%] m-auto">
          <input
            type="text"
            value={address}
            className="py-[12px] px-[8px] lg:w-[80%] md:w-[80%] outline-[#80bdff] text-[#495057] font-extrabold rounded-l-lg inputAddress relative"
            ...
            ref={inputRef}
          />
          <div className="delete absolute right-[5px] text-xl"><i class="fa-solid fa-xmark"></i></div>
          <button
