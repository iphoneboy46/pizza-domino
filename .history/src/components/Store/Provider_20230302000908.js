...
function Provider({ children }) {
  ...
  const [menuOrders, setMenuOrders] = useState(JSON.parse(localStorage.getItem("menuOrders") )??  []);
  const [orderAddress, setOrderAddress] = useState(JSON.parse(localStorage.getItem("orderAddress") )??  [])
  ...
  const [ghiChu,setGhiChu] = useState(JSON.parse(localStorage.getItem("ghichu") ?? ""))
