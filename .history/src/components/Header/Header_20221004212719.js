...
function Header() {
  ...
  return (
    <div>
      <div className="bg-[#004666] lg:flex md:flex p-[16px] w-[100%] h-[80px] items-center justify-between fixed z-[2000] overflow-hidden hidden">
        ...
        <div className="flex items-center">
          ...
          <div className="relative flex items-center">
            <Link to="" className="hover:bg-[#00628f] w-[100%] h-[100%] hover:text-wh mr-5">
              <i class="fa-solid fa-user text-white text-4xl px-[10px] py-[20px]"></i>
            </Link>
            <Link to="/cart" className="hover:bg-[#00628f] w-[100%] hover:text-wh mr-5">
      ...
      <div className="w-[100%] mt-5 bg-[#004666] z-[2000] lg:hidden md:hidden flex fixed justify-around items-center p-2">
        <div className="w-[10%]">
          <Link to="/">
