...
function Header() {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-[100px] bg-[#004666] z-[10] w-[100vh] h-[100vh] py-10">
        <ul className="text-white font-semibold uppercase flex flex-col justify-between items-center ">
          <li>
