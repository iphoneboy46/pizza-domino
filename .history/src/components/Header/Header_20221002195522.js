...
function Header() {
  ...
  return (
    <div>
      ...
      <div className="w-[100%] bg-[#004666] z-[2000] lg:hidden md:hidden flex fixed justify-around items-center">
        <div className="w-[10%]">
          <Link to="/">
        ...
        <div className="">
          <Link to="/">
            <img className="w-[10%] text-white" src="https://cdn-icons-png.flaticon.com/512/5637/5637217.png" alt="" />
          </Link>
        </div>
      </div>
    </div>
