  ...
  return (
    <div>
      <div className="bg-[#004666] lg:flex md:flex p-[16px] w-[100%] h-[80px] items-center justify-between fixed z-[2000] overflow-hidden hidden">
            ...
            {pages.map((page, i) => {
              return (
                <>
                  <li
                    key={i}
                    className="text-sm text-white font-extrabold uppercase lg:ml-5 md:ml-1 h-[100%] pl-5 pr-5 pt-8 pb-8 tracking-widest transition-all linear duration-500 hover:bg-[#00628f] hover:text-wh"
                  >
        ...
        <div className="flex items-center">
          ...
          <div className="relative flex items-center">
            {account.displayName ? (
              <h1 className="text-white font-bold w-[100%] truncate">Hi {account.displayName}</h1>
            ) : (
              <button
                onClick={handleLogin}
      ...
      <div className="w-[100%] bg-[#004666] z-[2000] lg:hidden md:hidden flex fixed justify-around items-center p-2">
        ...
        {account.displayName ? <h1 className="text-white font-bold w-[100%] truncate">Hi {account.displayName}</h1> : }
