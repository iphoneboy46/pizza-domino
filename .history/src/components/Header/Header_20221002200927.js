  ...
  return (
    <div>
      ...
      <div className="w-[100%] bg-[#004666] z-[2000] lg:hidden md:hidden flex fixed justify-around items-center p-2">
        ...
        <div className="w-[10%]">
          <Link to="/Donhang">
            <img className="w-[100%]" src="https://cdn-icons-png.flaticon.com/512/7541/7541900.png" alt="" />
          </Link>
        </div>
        <div className="w-[10%]">
          <Link to="/khuyenmai">
            <img className="w-[100%] " src="https://cdn-icons-png.flaticon.com/512/5412/5412898.png" alt="" />
          </Link>
        </div>
        <div className="w-[10%]">
          <Link to="/Thucdon">
            <img className="w-[100%] " src="https://cdn-icons-png.flaticon.com/512/1721/1721486.png" alt="" />
          </Link>
        </div>
        <div className="w-[10%]">
          <Link to="/">
            <img className="w-[100%] " src="https://cdn-icons-png.flaticon.com/512/1077/1077012.png" alt="" />
          </Link>
        </div>
        <div className="w-[10%]">
          <Link to="/">
            <img className="w-[100%] " src="https://cdn-icons-png.flaticon.com/512/4715/4715128.png" alt="" />
          </Link>
        </div>
      </div>
    </div>
