            ...
            {account.displayName ? (
              <div className="w-[100%]">
                <div className="relative w-[100%]">
                  <h1 className="text-white font-bold w-[100%] truncate flex justify-between items-center">
                    Hi {account.displayName} <i class="fa-solid fa-caret-down"></i>
                  </h1>
                </div>
                <div className="absolute bg-white w-[70%] p-1 z-50">
                  {" "}
