...
function Header() {
  ...
  return (
    <div className="relative">
      ...
      <ul className="text-white font-semibold uppercase flex flex-col justify-between h-[80vh] px-2 menu-Mobile absolute top-[100px] left-[-100%] bottom-0 right-0 bg-[#004666] z-[10] w-[100%] py-10 transition-all duration-500 linear lg:hidden md:hidden sm:block">
        <li>
