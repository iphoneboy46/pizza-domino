        ...
        <div className="flex items-center">
          ...
          <div className="relative flex items-center">
            ...
            <Link to="/cart" className="hover:bg-[#00628f] w-[100%] hover:text-wh mr-5">
              <i class="fa-solid fa-basket-shopping text-white text-4xl  px-[10px] py-[100%]"></i>
              <span className="bg-[#aa1934] absolute px-2 font-bold text-white right-[-4px] top-[0px] rounded">
