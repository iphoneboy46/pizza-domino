...
function Header() {
  ...
  return (
    <div className="relative">
      ...
      <div className="w-[100%] bg-[#004666] z-[2000] lg:hidden md:hidden flex fixed justify-around items-center py-10">
        <div className="w-[10%]">
          <Link to="/">
      ...
      <div className="absolute top-[100px] bg-[#004666] z-[10] w-[100vh] h-[100vh]">
        <ul className="text-white font-semibold uppercase">
          <li>
