            ...
            {pages.map((page, i) => {
              return (
                <>
                  <li
                    key={i}
                    className="lg:text-[20px] md:text-[10px] text-white font-extrabold uppercase lg:ml-5 md:ml-1 h-[100%] pl-5 pr-5 pt-8 pb-8 tracking-widest transition-all linear duration-500 hover:bg-[#00628f] hover:text-wh"
                  >
