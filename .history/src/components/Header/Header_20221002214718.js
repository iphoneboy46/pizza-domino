...
function Header() {
  ...
  const [btnExits, setbtnExits] = useState(false);
  const handleMenu = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="w-[100%] bg-[#004666] z-[2000] lg:hidden md:hidden flex fixed justify-around items-center p-2">
        ...
        <div className="w-[10%]">
          {btnExits ? (
            <button className="text-white text-xl" onClick={handleMenu}>
              <i class="fa-solid fa-bars"></i>
            </button>
          ) : (
            <button className="text-white text-xl" onClick={handleMenuExits}>
              <i class="fa-solid fa-xmark"></i>
            </button>
          )}
        </div>
      </div>
      <div className="menu-Mobile absolute top-[40px] left-[-100%] bg-[#004666] z-[10] w-[100%] h-[100vh] py-10 transition-all duration-500 linear lg:hidden md:hidden sm:block">
        <ul className="text-white font-semibold uppercase flex flex-col justify-between h-[80vh] px-2">
          <li>
