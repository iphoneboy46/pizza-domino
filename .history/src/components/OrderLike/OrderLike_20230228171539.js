      ...
      <div className="lg:w-[900px] md:w-[302%] mb-3 overflow-hidden">
        <div id="list-order" className=" flex justify-around items-center w-[900%]">
          {listOrderLikes.map((like) => {
            if (like.id <= 15) {
              return (
                <div className="list-items flex lg:justify-center lg:items-center lg:flex-col md:flex-row md:justify-between md:items-center">
                  <div className="lg:w-[195px] h-[130px] md:w-[150px] rounded-md mb-3">
