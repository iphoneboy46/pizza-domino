              ...
              return (
                <div>
                  <div className="w-[195px] h-[130px] rounded-md mb-3">
                   ...
                   <div className="border-[1px] border-[#E31837] w-[80%] m-auto p-1 font-bold text-[#E31837] text-center cursor-pointer hover:bg-[#E31837] hover:text-white duration-100 ease-linear">
                   Thêm vào giỏ hàng
                   </div>
                </div>
              );
