...
function OrderLike() {
  ...
  return (
    ...
    <div className="w-[35px] h-[35px] bg-[#EEEEEE] flex justify-center items-center rounded-2xl absolute top-[50%] left-5">
    <i className="fa-solid fa-angle-left text-2xl"></i>
    </div>
    <div className="w-[35px] h-[35px] bg-[#EEEEEE] flex justify-center items-center rounded-2xl absolute top-[50%] right-5">
