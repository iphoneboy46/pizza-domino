...
const handlePrev = () =>{
  ...
  return (
    <div className="border-[1px] border-[#0078AE] w-[100%] rounded-md py-5 px-2 relative overflow-hidden">
      ...
      <div className="w-[850px] mb-3">
        <div id="list-order" className=" flex justify-around items-center w-[1000%]">
              ...
              return (
                <div className="list-items flex justify-center items-center flex-col">
                  <div className="w-[195px] h-[130px] rounded-md mb-3">
                   ...
                   <div className="border-[1px] border-[#E31837] w-[200px] m-auto p-1 font-bold text-[#E31837] text-center cursor-pointer hover:bg-[#E31837] hover:text-white duration-150 ease-linear">
                   Thêm vào giỏ hàng
                   </div>
                </div>
              );
