        ...
        <div>
          <ul className="h-[50vh] overflow-y-scroll mb-5">
            {optionQ === "1"
              ? itemHCM.map((hcm) => {
                  return (
                    <li onClick={()=>{handleIP(hcm.ip)}} className="w-[100%] flex justify-around border-[#DFDFDF] border-solid border-2 p-4 mb-3 active:border-[#373495] active:border-solid active:border-2">
                      <div className="w-[10%]">
