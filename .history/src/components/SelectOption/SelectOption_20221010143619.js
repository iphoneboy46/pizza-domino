...
function SelectOption() {
  ...
  return (
    <div className="w-[20%] p-3 bg-white">
     ...
     {optionQ === "1" ? <Select placeholder="Chọn Quận/Huyện" options={optionQHCM} /> : <Select placeholder="Chọn Quận/Huyện" value="" />}
     {optionQ === "2" ? <Select placeholder="Chọn Quận/Huyện" options={optionQHN} /> : <Select placeholder="Chọn Quận/Huyện" value="" />}
    </div>
  );
}
