...
function SelectOption(props) {
  ...
  useEffect(() => {
    function checkAddress() {
      ...
      if (address.includes("Hà Đông") || address.includes("hà đông")) {
        setAddress2("Hà Đông");
      }

      if (address.includes("Từ Liêm") || address.includes("từ liêm")) {
        setAddress2("Từ Liêm");
      }

      if (address.includes("Long Biên") || address.includes("long biên")) {
        setAddress2("Long Biên");
      }

      if (address.includes("Thủ Dậu Một") || address.includes("thủ dậu một")) {
        setAddress2("Thủ Dậu Một");
      }

      if (address.includes("Biên Hòa") || address.includes("biên hòa")) {
        setAddress2("Biên Hòa");
      }

      if (address.includes("Hồng Bàng") || address.includes("hồng bàng")) {
        setAddress2("Hồng Bàng");
      }

      if (address.includes("Ngô Quyền") || address.includes("ngô quyền")) {
        setAddress2("Ngô Quyền");
      }
    }
    ...
    switch (address2) {
      ...
      case "Thủ Dậu Một":
        setOptions("3");
        setPlaceTP("Bình Đương");
        setPlaceQ("Thành Phố Thủ Dậu Một");
