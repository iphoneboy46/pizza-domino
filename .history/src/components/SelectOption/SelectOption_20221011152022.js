...
function SelectOption() {
  ...
  const handleActive = (index, id) => {
    const store = document.querySelector(".itemStore");
    const storeActive = document.querySelector(".itemStore.activeBorder");
    storeActive.classList.remove("activeBorder");
    if (id === index + 1) {
      store.classList.add("activeBorder");
    }
  };
              ...
              ? itemHCM.map((hcm, index) => {
                  return (
                    <li
                      onClick={() => {
                        handleIP(hcm.ip);
                        handleActive(index, hcm.id);
                      }}
                      className="itemStore w-[100%] flex justify-around border-[#DFDFDF] border-solid border-2 p-4 mb-3"
                    >
                      <div className="w-[10%]">
              ...
              ? itemHN.map((hn) => {
                  return (
                    <li
                      ...
                      className="w-[100%] flex justify-around border-[#DFDFDF] border-solid border-2 p-4 mb-3"
                    >
                      <div className="w-[10%]">
                        <i class="fa-solid fa-location-dot"></i>
                      </div>
