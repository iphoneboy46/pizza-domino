              ...
              ? itemHCM.map((hcm, index) => {
                  return (
                    <li
                      ...
                      className={activeItem === index ? "w-[100%] flex justify-around border-[#DFDFDF] border-solid border-2 p-4 mb-3 activeBorder" : "w-[100%] flex justify-around border-[#DFDFDF] border-solid border-2 p-4 mb-3"}
                    >
                      <div className="w-[10%]">
