          ...
          <ul className="h-[50vh] overflow-y-scroll mb-5">
            {optionQ === "1"
              ? itemHCM.map((hcm,index) => {
                  return (
                    <li onClick={()=>{handleIP(hcm.ip)}} className=`${hcm.id} === index ? "w-[100%] flex justify-around border-[#DFDFDF] border-solid border-2 p-4 mb-3 active" : "w-[100%] flex justify-around border-[#DFDFDF] border-solid border-2 p-4 mb-3 "`>
                      <div className="w-[10%]">
            ...
            {optionQ === "2"
              ? itemHN.map((hn) => {
                  return (
                    <li onClick={()=>{handleIP(hn.ip)}} className="w-[100%] flex justify-around border-[#DFDFDF] border-solid border-2 p-4 mb-3">
                      <div className="w-[10%]">
                        <i class="fa-solid fa-location-dot"></i>
                      </div>
                      <di className="w-[90%]">
            ...
            {optionQ === "3"
              ? itemBD.map((bd) => {
                  return (
                    <li onClick={()=>{handleIP(bd.ip)}} className="w-[100%] flex justify-around border-[#DFDFDF] border-solid border-2 p-4 mb-3">
                      <div className="w-[10%]">
                        <i class="fa-solid fa-location-dot"></i>
                      </div>
                      <di className="w-[90%]">
            ...
            {optionQ === "4"
              ? itemDN.map((dn) => {
                  return (
                    <li onClick={()=>{handleIP(dn.ip)}} className="w-[100%] flex justify-around border-[#DFDFDF] border-solid border-2 p-4 mb-3">
                      <div className="w-[10%]">
                        <i class="fa-solid fa-location-dot"></i>
                      </div>
                      <di className="w-[90%]">
            ...
            {optionQ === "5"
              ? itemHP.map((hp) => {
                  return (
                    <li onClick={()=>{handleIP(hp.ip)}} className="w-[100%] flex justify-around border-[#DFDFDF] border-solid border-2 p-4 mb-3">
                      <div className="w-[10%]">
                        <i class="fa-solid fa-location-dot"></i>
                      </div>
                      <di className="w-[90%]">
