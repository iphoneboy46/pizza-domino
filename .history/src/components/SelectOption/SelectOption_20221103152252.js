...
function SelectOption(props) {
  ...
  useEffect(() => {
    function checkAddress() {
      if (address.includes("Bình Tân")) {
        setAddress2("Bình Tân");
      }

      if (address.includes("Bình Chánh")) {
        setAddress2("Bình Chánh");
      }

      if (address.includes("Bình Thạnh")) {
        setAddress2("Bình Thạnh");
      }

      if (address.includes("Gò Vấp")) {
        setAddress2("Gò Vấp");
      }

      if (address.includes("Hóc Môn")) {
        setAddress2("Hóc Môn");
      }

      if (address.includes("Phú Nhuận")) {
      ...
      if (address.includes("Quận 2")) {
        setAddress2("Quận 2");
      }

      if (address.includes("Quận 3")) {
        setAddress2("Quận 3");
      }

      if (address.includes("Quận 4")) {
        setAddress2("Quận 4");
      }
      
      if (address.includes("Quận 5")) {
        setAddress2("Quận 5");
      }

      if (address.includes("Quận 6")) {
        setAddress2("Quận 6");
      }

      if (address.includes("Quận 7")) {
        setAddress2("Quận 7");
      }

      if (address.includes("Quận 8")) {
        setAddress2("Quận 8");
      }

      if (address.includes("Quận 9")) {
        setAddress2("Quận 9");
      }

      if (address.includes("Quận 10")) {
        setAddress2("Quận 10");
      }

      if (address.includes("Quận 11")) {
        setAddress2("Quận 11");
      }

      if (address.includes("Quận 12")) {
        setAddress2("Quận 12");
      }

      if (address.includes("Tân Bình")) {
        setAddress2("Tân Bình");
      }

      if (address.includes("Tân Phú")) {
        setAddress2("Tân Phú");
      }

      if (address.includes("Thủ Đức")) {
        setAddress2("Thủ Đức");
      }
    }
