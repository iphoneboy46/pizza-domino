...
function SelectOption() {
  ...
  return (
    <div className="lg:w-[25%] md:w-[100%] p-10 bg-white">
      <Select
        ...
        <div>
          <ul className="h-[50vh] overflow-y-scroll mb-5">
            {optionQ === "1"
              ? itemHCM.map((hcm) => {
                  return (
                    <li onClick={()=>{handleIP(hcm.ip)}} className="w-[100%] flex justify-around border-[#DFDFDF] border-solid border-2 p-4 mb-3">
                      <div className="w-[10%]">
