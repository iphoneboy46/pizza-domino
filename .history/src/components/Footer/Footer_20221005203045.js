...
function Footer() {
  return (
    <div className="footer">
      <div className="lg:w-[55%] md:w-[100%] w-[100%] h-[100px] m-auto pt-5">
          ...
          <div className="lg:block md:block flex flex-col items-center justify-center ">
            <div className="flex-1 h-[120px] py-[24px] pr-[24px] pl-0 flex items-center mr-10">
              <img
                ...
                alt="domino pizza"
              />
              <div className="border-style: solid lg:border-l-[1px] md:border-l-[1px] border-l-0 border-[#004666] pl-8 lg:h-[100px] md:h-[100px] h-[70px] m-auto">
