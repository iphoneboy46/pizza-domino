  ...
  return (
    <div className="footer">
      <div className="w-[80%] m-auto pt-5">
        ...
        <div className="lg:flex lg:items-center lg:justify-between md:flex md:justify-around md:items-center md:mx-5 hidden">
          ...
          <div className="lg:flex flex-1 justify-evenly items-start text-graycustom font-semibold md:hidden">
        ...
        <div className="lg:flex md:flex hidden items-center justify-between md:justify-around ">
