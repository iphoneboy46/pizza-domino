    ...
    <div className="footer">
      <div className="w-[100%] m-auto pt-5">
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1 h-[120px] py-[24px] pr-[24px] pl-0 flex items-center mr-10 md:justify-around">
          ...
          <div className="flex flex-1 justify-around items-start text-graycustom font-semibold md:hidden ">
