  ...
  return (
    <div className="footer">
      <div className="lg:w-[60%] md:w-[100%] w-[100%] m-auto pt-5">
        ...
        <div className="lg:flex md:flex flex items-center justify-between md:justify-around ">
          <span className="text-[#0ca3ea] text-[12px] font-semibold ml-5 text-center">© 2020 Domino’s Pizza Vietnam | Privacy Policy</span>
