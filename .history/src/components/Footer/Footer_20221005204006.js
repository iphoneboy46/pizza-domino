        ...
        <div className="lg:flex lg:items-center lg:justify-between md:flex md:justify-around md:items-center md:mx-5 h">
          <div className="lg:block md:block flex flex-col items-center justify-center ">
            <div className="flex-1 h-[120px] py-[24px] pl-0 flex items-center mr-10">
              ...
              <div className="border-style: solid lg:border-l-[1px] md:border-l-[1px] border-l-0 border-[#004666]"></div>
              <div className=" lg:h-[100px] md:h-[100px] h-[70px] flex items-center justify-center flex-col ml-[60px]">
