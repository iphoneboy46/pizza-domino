        ...
        <div className="lg:flex lg:items-center lg:justify-between md:flex md:justify-around md:items-center md:mx-5 h">
          <div>
            <div className="flex-1 h-[120px] py-[24px] pr-[24px] pl-0 flex items-center mr-10">
              ...
              <div className="border-style: solid lg:border-l-[1px] md:border-l-[1px] border-l-0 border-[#004666] pl-8 h-[100px] m-auto">
                <p className="text-white text-[14px] font-semibold italic text-center pt-2"><i class="fa-solid fa-phone"></i> Hotline Đặt Hàng</p>
                <a className="text-yellowcustom text-[40px] font-extrabold " href="tel:19006099">1900 6099</a>
              </div>
             
            </div>
            <div className="mt-2 lg:block md:block flex items-center justify-between w-[100%]"> 
            <span className="text-[#0ca3ea] text-[12px] font-semibold text-center">© 2020 Domino’s Pizza Vietnam | Privacy Policy</span>
            </div>
          </div>
