  ...
  return (
    <div className="footer">
      <div className="w-[100%] m-auto pt-5">
        ...
        <div className="flex items-center justify-between md:hidden md:justify-around">
          ...
          <div className="flex flex-1 justify-evenly items-start text-graycustom font-semibold">
