          ...
          <div className="lg:block md:block flex flex-col items-center justify-center ">
            <div className="flex-1 h-[120px] py-[24px] pr-[24px] pl-0 flex items-center mr-10">
              <img
                ...
                alt="domino pizza"
              />
              <div className="w-[100%] border-style: solid lg:border-l-[1px] md:border-l-[1px] border-l-0 border-[#004666] lg:h-[100px] md:h-[100px] h-[70px] m-auto flex items-center justify-center flex-col">
