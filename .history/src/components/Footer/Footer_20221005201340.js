      ...
      <div className="w-[60%] m-auto pt-5">
        ...
        <div className="lg:flex lg:items-center lg:justify-between md:flex md:justify-around md:items-center md:mx-5 h">
          <div className="flex-1 h-[120px] py-[24px] pr-[24px] pl-0 flex items-center mr-10">
            ...
            <div className="border-style: solid lg:border-l-[1px] md:border-l-[1px]  border-[#004666] pl-8 h-[120px] m-auto">
        ...
        <div className="lg:flex md:flex items-center justify-between md:justify-around ">
          <span className="text-[#0ca3ea] text-[12px] font-semibold ml-5">© 2020 Domino’s Pizza Vietnam | Privacy Policy</span>
