...
function Login() {
  ...
  return (
    <div className="login-form flex lg:w-[45%] md:w-[90%] w-[100%] transition-all duration-500 linear rounded-md opacity justify-between items-center fixed -top-[100%] left-[50%] bg-white -translate-y-[50%] -translate-x-[50%] z-[99999]">
      <div className="login-success absolute hidden left-[0%] bg-white w-[100%] h-[100%] z-1000  justify-center items-center flex-col rounded-md ">
        <h1 className="text-center font-bold mb-5 text-xl">Đăng nhập thành công</h1>
        <button onClick={handleOk} className="py-2 px-[50px] bg-[#E31837] text-white font-bold rounded">OK</button>
      </div>
      <div
        onClick={handleEx}
