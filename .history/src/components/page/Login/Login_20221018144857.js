...
function Login() {
  ...
  return (
    <div className="login-form flex w-[45%] transition-opacity duration-[5000] linear rounded-md justify-between items-center fixed -top-[100%] left-[50%] bg-white -translate-y-[50%] -translate-x-[50%] z-[99999]">
