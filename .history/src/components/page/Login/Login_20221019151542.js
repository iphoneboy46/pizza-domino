...
function Login() {
  ...
  return (
    <div className="login-form flex lg:w-[45%] md:w-[90%] w-[100%] transition-all tr duration-500 linear rounded-md opacity justify-between items-center fixed -top-[100%] left-[50%] bg-white -translate-y-[50%] -translate-x-[50%] z-[99999]">
      <div className="login-success absolute left-[50%] bg-white w-[50%] height-[50%] z-1000">
