...
function Login() {
  ...
  return (
    <div className="login-form flex w-[45%] transition-all tr transition-duration-[5000] linear rounded-md justify-between items-center fixed -top-[100%] left-[50%] bg-white -translate-y-[50%] -translate-x-[50%] z-[99999]">
      <div onClick={handleEx} className="absolute top-[0px] bg-[#c0142f] p-2 px-4 text-2xl text-white right-0 rounded-tr-md">
      ...
      <div className="py-[30px] w-[50%] mt-[15px]">
