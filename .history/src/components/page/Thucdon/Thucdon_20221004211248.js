    ...
    <div className="pt-[80px] w-[100%] flex h-[100vh] overflow-hidden">
      <div className="lg:w-[75%] md:w-[100%] ">
        ...
        {orderAddress.address ? (
          <div className="bg-[#e3f4fc] flex lg:flex-row md:flex-row lg:justify-between lg:items-center md:justify-between md:items-center flex-col items-center flex-wrap">
