      ...
      <div className="lg:w-[75%] md:w-[100%] ">
        ...
        {orderAddress.address ? (
          <>
            ...
            <div className="bg-[#e3f4fc] lg:hidden md:hidden block ">
              <div className="flex items-center justify-between p-2  text-[#6a6b6c] font-semibold">
               <div className="flex">
                  <h1 className="mr-5">Bạn đang chọn:</h1>
                  <h1 className="mr-5 text-[#de1736]">
                    {orderAddress.takeAway || orderAddress.deliver}
                ...
                <div className="p-2" onClick={handleSelectAddress}>
                <i class="fa-solid fa-pen"></i>
              </div>
              </div>
              <h1>{orderAddress.address}</h1>
