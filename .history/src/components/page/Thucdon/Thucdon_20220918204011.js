...
function Thucdon() {
  ...
  const { menuOrders, address } = useContext(Context);
      ...
      <div className="w-[1515px] ">
        ...
        {address ? (
          <div className="bg-[#e3f4fc]">
            <div className="flex items-center p-4 ml-[100px] justify-around text-[#212529] font-semibold">
              <h1 className="ml-2">Bạn đang chọn:</h1>
              <h1>ĐẶT ĐẾN LẤY </h1>
              <h1>{address}</h1>
           </div>
          </div>
