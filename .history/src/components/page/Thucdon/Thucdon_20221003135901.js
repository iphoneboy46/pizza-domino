  ...
  return (
    <div className="pt-[80px] w-[100%] flex h-[100vh] overflow-hidden">
      <div className="lg:w-[75%] md:w-[100%] ">
        ...
        <div className="btn-list lg:flex md:flex grid grid-flow-col auto-cols-[80%] justify-around w-[100%] lg:px-[120px] md:px-[120px] py-2 bg-white font-semibold cursor-pointer snap-x overflow-x-scroll">
          <div className="">
