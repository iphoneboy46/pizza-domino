    ...
    <div className="pt-[80px] w-[100%] flex h-[100vh] overflow-hidden">
      <div className="lg:w-[75%] md:w-[100%] ">
        ...
        <div className="w-[100%]lg:overflow-hidden md:overflow-hidden overflow-x-scroll">
          <div className="btn-list flex justify-around lg:w-[100%] md:w-[100%] w-[180%] lg:px-[120px] md:px-[120px] py-2 bg-white font-semibold cursor-pointer lg:mb-0 md:mb-0 mb-5">
            <div className="">
