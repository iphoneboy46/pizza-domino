            ...
            <div className="bg-white w-[80%] m-[auto]">
              ...
              <div className="border-b-[1px] border-[#DFE4EA] mb-5">
                    <div className="flex justify-between items-start mb-5">
                      <span className="font-bold">{donHang.data.quantity}</span>
                      <span className="font-bold">x</span>
                      <h1 className="font-bold w-[50%] text-sm text-start">
                        {donHang.data.name}
                      </h1>
                      <h1 className="font-bold text-sm">{donHang.data.totalP}.000 đ</h1>
                    </div>
                    <div className="flex justify-between items-start">
                      ...
                      <div className="lg:w-[30%] md:w-[35%] w-[30%] pb-8">
                        ...
                        <h6 className="font-bold text-xs text-[#717273]">
                          {donHang.data.border9}
                        </h6>
                        <h6 className="font-bold text-xs text-[#717273]">
                          {donHang.data.border12}
                        </h6>
                        <h6 className="font-bold text-xs text-[#717273]">
                          {donHang.data.more9}
                        </h6>
