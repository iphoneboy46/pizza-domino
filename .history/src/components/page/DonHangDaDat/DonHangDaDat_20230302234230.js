        ...
        {listDonHang.map((donHang) => {
          return (
            <div className="bg-white w-[80%] m-[auto]">
              ...
              <div className="w-[100%] p-5 flex justify-between border-b-[1px] border-[lightgray]">
                <h1 className="text-xl font-bold text-start">Xuất hóa đơn đỏ :</h1>
                <span className="text-end">{donHang.xuatHoaDonDo}</span>
              </div>
              {
                donHang.nameCompany && <div className="w-[100%] p-5 flex justify-between border-b-[1px] border-[lightgray]">
                <h1 className="text-xl font-bold text-start">Tên công ty :</h1>
                <span className="text-end">{donHang.nameCompany}</span>
              </div>
              }
              {
                donHang.addressCompany && <div className="w-[100%] p-5 flex justify-between border-b-[1px] border-[lightgray]">
                <h1 className="text-xl font-bold text-start">Tên công ty :</h1>
                <span className="text-end">{donHang.addressCompany}</span>
              </div>
              }
               {
                donHang.maSoThue && <div className="w-[100%] p-5 flex justify-between border-b-[1px] border-[lightgray]">
                <h1 className="text-xl font-bold text-start">Mã số thuế :</h1>
                <span className="text-end">{donHang.maSoThue}</span>
              </div>
              }
              {
                donHang.emailDienTu && <div className="w-[100%] p-5 flex justify-between border-b-[1px] border-[lightgray]">
                <h1 className="text-xl font-bold text-start">Email nhận hóa đơn điện tử :</h1>
