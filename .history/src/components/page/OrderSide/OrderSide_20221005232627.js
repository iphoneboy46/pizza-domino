...
function OrderSide() {
  ...
  return (
    <div>
      <div className="order-SideDishes w-[800px] h-[calc(100vh-400px)] bg-white flex lg:flex-row md:flex-row  m-auto fixed -top-[100%] left-[50%] -translate-x-[50%] rounded-[6px] ease-in duration-500 z-[9999]">
