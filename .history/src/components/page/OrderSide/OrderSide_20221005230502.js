...
function OrderSide() {
  ...
  return (
    <div className="order-SideDishes w-[800px] h-[calc(100vh-400px)] bg-white  m-auto fixed -top-[100%] left-[50%] -translate-x-[50%] rounded-[6px] ease-in duration-500 z-[9999]">
