...
function OrderSide() {
  ...
  return (
    ...
    <div className="flex items-center flex-col lg:h-[40%] md:h-[100%] h-[30%] p-5 solid border-t-2 border-[#dee2e6] shadow-[0px_0px_16px_rgb(0,42,61,16%)] overflow-hidden lg:hidden md:hidden">
