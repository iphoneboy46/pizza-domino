...
function OrderSide() {
  ...
  return (
    ...
    <div className="flex lg:flex-row md:flex-row flex-col overflow-y-scroll">
      ...
      <div className="alert-address2 lg:w-[50%] md:w-[50%] w-[80%] md:h-[45%] h-[50%] absolute bg-[#f2f4f8] top-[50%] left-[50%] z-[99999] -translate-x-[50%] -translate-y-[50%] rounded-md hidden">
