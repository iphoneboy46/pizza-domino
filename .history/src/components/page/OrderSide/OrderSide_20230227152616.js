...
function OrderSide() {
  ...
  return (
      ...
      <div className="lg:w-[60%] md:w-[60%] w-[100%] h-[100%] flex flex-col">
        ...
        <div className="lg:flex md:flex hidden items-center h-[20%] p-3 solid border-t-2 border-[#dee2e6] shadow-[0px_0px_16px_rgb(0,42,61,16%)]">
          <div className="flex items-center">
            ...
            <button onClick={handlePlus} className="bg-[#dfe4ea] py-3 px-4 rounded-r-lg w-[50px] hover:bg-[#c8d1db] active:bg-[#c0cad6] active:border-[#c0cad6]">
    ...
    <div className="flex items-center flex-col h-[30%] p-5 solid border-t-2 border-[#dee2e6] shadow-[0px_0px_16px_rgb(0,42,61,16%)] overflow-hidden lg:hidden md:hidden">
