...
function OrderSide() {
  ...
  return (
    <div className="order-SideDishes lg:w-[10%] md:w-[90%] w-[90%] lg:h-[calc(100vh-60%)] md:h-[calc(100vh-60%)]  h-[calc(100vh-40%)] bg-white flex lg:flex-row md:flex-row flex-col m-auto fixed -top-[100%] left-[50%] -translate-x-[50%] rounded-[6px] ease-in duration-500 z-[9999] lg:overflow-hidden md:overflow-hidden">
