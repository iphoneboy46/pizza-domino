...
function OrderSide() {
  ...
  return (
    ...
    <div className="flex lg:flex-row md:flex-row flex-col overflow-y-scroll">
      ...
      <div className="alert-card2 lg:w-[50%] md:w-[50%] w-[80%] h-[auto] absolute bg-[#f2f4f8] top-[50%] left-[50%] z-[99999] -translate-x-[50%] -translate-y-[50%] rounded-md hidden z-10">
        <div
      ...
      <div className="alert-address2 lg:w-[50%] md:w-[50%] w-[80%] md:h-[45%] h-[40%] absolute bg-[#f2f4f8] top-[50%] left-[50%] z-[99999] -translate-x-[50%] -translate-y-[50%] rounded-md hidden">
    ...
    <div className="flex items-center flex-col h-[50%] lg:p-5 p-2 solid border-t-2 border-[#dee2e6] shadow-[0px_0px_16px_rgb(0,42,61,16%)] overflow-hidden lg:hidden md:hidden">
