...
function Order() {
  ...
  return (
    <div className="order-pizza lg:w-[50%] md:w-[50%] w-[90%]  h-[calc(100vh-20%)] bg-white flex lg:flex-row md:flex-row flex-col m-auto fixed -top-[100%] left-[50%] -translate-x-[50%] rounded-[6px] ease-in duration-500 z-[9999]">
