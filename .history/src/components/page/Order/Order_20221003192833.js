...
function Order() {
  ...
  useEffect(() => {
    ...
    const btnExits = document.querySelector(".btn-exits");
  ...
  useEffect(() => {
    const btnExitss = document.querySelector(".btn-exitss");
    const alertMsg = document.querySelector(".alert-address");
    const alertCard = document.querySelector(".alert-card");
    const orderPizza = document.querySelector(".order-pizza");
    const content = document.querySelector(".content");
  ...
  return (
    <div className="order-pizza lg:w-[50%] md:w-[50%] w-[90%]  h-[calc(100vh-20%)] bg-white flex lg:flex-row md:flex-row flex-col m-auto fixed -top-[100%] left-[50%] -translate-x-[50%] rounded-[6px] ease-in duration-500 z-[9999] overflow-y-scroll">
      <div className="btn-exits absolute bg-[#c0142f] p-2 px-4 text-2xl text-white right-0 rounded-tr-md">
        <i class="fa-solid fa-xmark"></i>
      </div>
      <div className="alert-card w-[50%] h-[30%] absolute bg-[#f2f4f8] top-[50%] left-[50%] z-[99999] -translate-x-[50%] -translate-y-[50%] rounded-md hidden">
      ...
      <div className="alert-address w-[50%] h-[30%] absolute bg-[#f2f4f8] top-[50%] left-[50%] z-[99999] -translate-x-[50%] -translate-y-[50%] rounded-md hidden">
        <div className="btn-exitss absolute bg-[#c0142f] py-2 px-4 text-2xl text-white right-0 rounded-tr-md">
          <i class="fa-solid fa-xmark"></i>
        </div>
        <h1 className="font-bold text-center mt-[60px]">Thông báo</h1>
      ...
      <div className=" lg:w-[40%] md:w-[40%] w-[100%] lg:h-[100%] md:h-[100%] h-[30%]  rounded-l-lg">
        <img
      ...
      <div className="lg:w-[60%] md:w-[60%] w-[100%] h-[100%] flex flex-col">
        <div className="h-[90%]  py-2 px-8 lg:overflow-y-scroll md:overflow-y-auto">
          <div>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between ">
                    ...
                    />
                    <label for={cake.name} className="font-bold relative ml-10">
