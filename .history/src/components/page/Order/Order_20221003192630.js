...
function Order() {
  ...
  return (
    <div className="order-pizza lg:w-[50%] md:w-[50%] w-[90%]  h-[calc(100vh-20%)] bg-white flex lg:flex-row md:flex-row flex-col m-auto fixed -top-[100%] left-[50%] -translate-x-[50%] rounded-[6px] ease-in duration-500 z-[9999] overflow-hidden">
      ...
      <div className=" lg:w-[40%] md:w-[40%] w-[100%] lg:h-[100%] md:h-[100%] h-[30%] rounded-l-lg">
        <img
          className="w-[10%] h-[100%] bg-no-repeat rounded-l-lg"
