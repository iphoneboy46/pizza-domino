...
function Order() {
  ...
  return (
    <div className="order-pizza w-[800px] h-[calc(100vh-20%)] bg-white flex lg:flex-row md:flex-row flex-col m-auto fixed -top-[100%] left-[50%] -translate-x-[50%] rounded-[6px] ease-in duration-500 z-[9999]">
      ...
      <div className=" lg:w-[100%] md:w-[100%] w-[100%] lg:h-[100%] md:h-[100%] h-[50%] rounded-l-lg">
        <img
