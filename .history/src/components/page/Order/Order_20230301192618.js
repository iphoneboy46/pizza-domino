...
function Order() {
  ...
  return (
    <div className="order-pizza lg:w-[800px] md:w-[90%] w-[90%]  h-[calc(100vh-20%)] bg-white flex lg:flex-row md:flex-row flex-col m-auto fixed -top-[100%] left-[50%] -translate-x-[50%] rounded-[6px] ease-in duration-500 z-[9999] lg:overflow-hidden md:overflow-hidden">
      <div className="flex lg:flex-row md:flex-row flex-col overflow-y-scroll">
        ...
        <div className="alert-card lg:w-[50%] md:w-[50%] w-[80%] absolute bg-[#f2f4f8] top-[50%] left-[50%] z-[99999] -translate-x-[50%] -translate-y-[50%] rounded-md hidden">
          ...
          <h1 className="font-bold text-center mt-2 mb-2">
        ...
        <div className="lg:w-[60%] md:w-[60%] w-[100%] h-[100%] flex flex-col">
          <div className="h-[90%]  py-2 px-8 lg:overflow-y-scroll md:overflow-y-scroll">
            <div>
              <h1 className="text-[#0078ae] lg:text-4xl md:text-4xl text-4xl font-bold text-left lg:leading-[48px] md:leading-[48px] leading-[60px] tracking-[3px]">
                {orderPizza.name}
              </h1>
            </div>
            <div className="mt-5">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between ">
                      ...
                      <label
                        for={cake.name}
                        className="labelOd font-bold relative lg:ml-10 md:ml-10 ml-4"
                      >
          ...
          <div className="h-[10%] p-3 solid border-t-2 border-[#dee2e6] shadow-[0px_0px_16px_rgb(0,42,61,16%)]">
            <div className="m-auto lg:flex md:flex hidden items-center justify-center">
              <div className="flex items-center justify-between">
                <button
      ...
      <div className="flex items-center justify-center flex-col ld:h-[80%] md:h-[80%] h-[100%] p-5 solid border-t-2 border-[#dee2e6] shadow-[0px_0px_16px_rgb(0,42,61,16%)] overflow-hidden lg:hidden md:hidden">
        ...
        <div className="ml-2">
          <button
            className="bg-[#e31837] w-[auto] rounded py-3 lg:px-0 md:px-0 px-3 text-white font-bold hover:bg-[#c0142f]"
            onClick={() => {
              handleOrder(orderPizza, OrderStyle);
            }}
          >
