...
function OrderEditDishes() {
  ...
  return (
    <div className="order-DishesEdit lg:w-[50%] md:w-[90%] w-[90%]  h-[calc(100vh-80%)] bg-white flex lg:flex-row md:flex-row flex-col m-auto fixed -top-[100%] left-[50%] -translate-x-[50%] rounded-[6px] ease-in duration-500 z-[9999] lg:overflow-hidden md:overflow-hidden">
