...
function OrderEditDishes() {
  ...
  const handleOrderEditDishes = () => {
    ...
    if (address) {
      ...
      const pizzaId = menuOrders.find((menuOrder) => {
        return menuOrder.id === orderSideDishes.id;
      });
  ...
  return (
    <div className="order-DishesEdit lg:w-[40%] md:w-[90%] w-[90%] lg:h-[calc(100vh-60%)] md:h-[calc(100vh-60%)]  h-[calc(100vh-40%)] bg-white flex lg:flex-row md:flex-row flex-col m-auto fixed -top-[100%] left-[50%] -translate-x-[50%] rounded-[6px] ease-in duration-500 z-[9999] lg:overflow-hidden md:overflow-hidden">
        ...
        <div className="lg:w-[60%] md:w-[60%] w-[100%] h-[100%] flex flex-col">
          ...
          <div className="lg:flex md:flex hidden items-center h-[10%] p-3 solid border-t-2 border-[#dee2e6] shadow-[0px_0px_16px_rgb(0,42,61,16%)]">
            ...
            <div className="ml-2">
              ...
              >
                Cập nhật sản phẩm <span>{orderSideDishes.price * quantity} 000₫</span>
              </button>
            </div>
          </div>
        </div>
      </div>
      <div className="flex items-center flex-col h-[60%] p-5 solid border-t-2 border-[#dee2e6] shadow-[0px_0px_16px_rgb(0,42,61,16%)] overflow-hidden lg:hidden md:hidden">
