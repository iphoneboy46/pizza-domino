...
function Pizza() {
  ...
  return (
    <div className="bg-[#f2f4f8] h-[840px] lg:pb-[450px] md:pb-[10px] pb-[500px]  p-5 lg:px-[80px] md:px-[10px] px-0 overflow-y-scroll">
      <div className="flex lg:w-[50%] md:w-[70%] w-[80%] lg:flex-nowrap md:flex-nowrap flex-wrap justify-between lg:ml-[8%] md:ml-[12%] ml-10 mt-5 cursor-pointer">
        <div
          ...
          {items1.map((pizza, index) => {
            return (
              ...
              >
                ...
                <div className="p-2 lg:h-[90px] md:h-[50%] h-[50%] text-[#0078ae] text-center font-semibold">
                  <button
                    onClick={() => {
                      handlePizza(pizza);
                    }}
                    className="hover:underline lg:text-md md:text-sm leading-10"
                  >
                    {pizza.name}
                  </button>
                </div>
