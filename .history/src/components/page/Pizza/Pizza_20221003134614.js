...
function Pizza() {
  ...
  return (
    <div className="bg-[#f2f4f8] h-[840px]  lg:pb-[250px] md:mb-[10px] px-2 overflow-y-scroll">
      ...
      <div className="favorite">
        ...
        <div className="grid lg:w-[100%] md:w-[100%] w-[100vw] md:grid-flow-row px-4 lg:grid-flow-row lg:grid-cols-4 md:grid-cols-4 lg:auto-cols-fr md:auto-cols-fr lg:gap-[30px] md:gap-[20px] gap-[10px] mt-5 grid-flow-col auto-cols-[80%] snap-x snap-mandatory overflow-x-scroll scroll-smooth snap-always">
