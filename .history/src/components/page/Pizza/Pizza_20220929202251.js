...
function Pizza() {
  ...
  return (
    <div className="bg-[#f2f4f8] h-[800px] pb-[250px] overflow-y-scroll">
      <div className="flex w-[500px] justify-between ml-[12%] mt-5 cursor-pointer">
        <div
          ...
          {items1.map((pizza, index) => {
            return (
              ...
              >
                ...
                <div className="p-2 lg:h-[110px] md:h-[140px] text-[#0078ae] text-center font-semibold">
                  <button
                    onClick={() => {
                      handlePizza(pizza);
                    }}
          ...
          {items2.map((pizza, index) => {
            return (
              ...
              >
                ...
                <div className="p-2 h-[110px] text-[#0078ae] text-center font-semibold">
                  <button
                    onClick={() => {
                      handlePizza(pizza);
                    }}
      ...
      <div className="signature pb-5">
        ...
        <div className="grid grid-cols-4 auto-cols-fr gap-[30px] mt-5 px-[100px]">
