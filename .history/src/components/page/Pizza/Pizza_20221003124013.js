  ...
  return (
    <div className="bg-[#f2f4f8] h-[840px]  lg:pb-[250px] md:mb-[10px] overflow-y-scroll overflow-x-hidden">
      ...
      <div className="premium">
        ...
        <div className="grid g:grid-cols-4 md:grid-cols-4 lg:auto-cols-fr md:auto-cols-fr lg:gap-[30px] md:gap-[20px] gap-[10px] mt-5 grid-flow-col auto-cols-[30%] snap-x px-[100px] overflow-x-scroll">
