  ...
  return (
    <div className="bg-[#f2f4f8] h-[840px]  lg:pb-[250px] md:mb-[10px] overflow-y-scroll">
      ...
      <div className="premium">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-4 lg:auto-cols-fr md:auto-cols-fr g:gap-x-[30px] md:gap-x-[20px] scroll-smooth gap-5 mt-5 snap-x grid-flow-col auto-cols-[80%] overflow-x-scroll snap-end snap-always">
