...
function Pizza() {
  ...
  return (
    <div className="bg-[#f2f4f8] h-[840px]  lg:pb-[450px] md:pb-[10px] pb-[400px]  p-5 lg:px-[80px] md:px-[10px] px-0 overflow-y-scroll">
          ...
          {items1.map((pizza, index) => {
            return (
              ...
              >
                ...
                <div className="p-2 lg:h-[20%] md:h-[50%] text-[#0078ae] text-center font-semibold">
                  <button
                    onClick={() => {
                      handlePizza(pizza);
                    }}
