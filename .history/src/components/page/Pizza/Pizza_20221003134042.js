...
function Pizza() {
  ...
  return (
    <div className="bg-[#f2f4f8] h-[840px]  lg:pb-[250px] md:mb-[10px] overflow-y-scroll">
      <div className="flex lg:w-[50%] md:w-[70%] w-[80%] lg:flex-nowrap md:flex-nowrap flex-wrap justify-between lg:ml-[12%] md:ml-[12%] ml-0 mt-5 cursor-pointer">
        <div
      ...
      <div className="premium">
        ...
        <div className="flex justify-center">
          <div className="flex lg:items-center md:items-center lg:flex-row md:flex-row flex-col justify-between items-center">
            <img
              className="mr-2"
          ...
          <div className="flex lg:items-center md:items-center mx-4 lg:flex-row md:flex-row flex-col justify-between items-center">
            <img
              className="mr-2"
        ...
        <div className="grid lg:w-[100%] md:w-[100%] w-[100vw]  px-4 lg:grid-flow-row md:grid-flow-row lg:grid-cols-4 md:grid-cols-4 lg:auto-cols-fr md:auto-cols-fr lg:gap-[30px] md:gap-[20px] gap-[10px] mt-5 grid-flow-col auto-cols-[80%] snap-x overflow-x-scroll scroll-smooth snap-end snap-always">
      ...
      <div className="favorite">
        ...
        <div className="grid lg:w-[100%] md:w-[100%] w-[100vw] md:grid-flow-row px-4 lg:grid-flow-row lg:grid-cols-4 md:grid-cols-4 lg:auto-cols-fr md:auto-cols-fr lg:gap-[30px] md:gap-[20px] gap-[10px] mt-5 grid-flow-col auto-cols-[80%] snap-x overflow-x-scroll scroll-smooth snap-always">
          {items2.map((pizza, index) => {
            return (
              <div
                key={index}
                className="rounded-[10px] border-style: solid border-2 flex flex-col border-[#dfe4ea] bg-white snap-center"
              >
                <div className="w-[100%] h-[auto] mb-4 overflow-hidden rounded-t-lg">
                  <img
                    className="w-[100%] h-[100%] rounded-t-lg ease-in duration-150 hover:scale-110"
      ...
      <div className="signature pb-5">
        ...
        <div className="grid lg:w-[100%] md:w-[100%] w-[100vw]  md:grid-flow-row px-4 lg:grid-flow-row lg:grid-cols-4 md:grid-cols-4 lg:auto-cols-fr md:auto-cols-fr lg:gap-[30px] md:gap-[20px] gap-[10px] mt-5 grid-flow-col auto-cols-[80%] snap-x overflow-x-scroll scroll-smooth snap-mandatory snap-always">
