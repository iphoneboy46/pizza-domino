...
function Donhang() {
  return (
    <div className="flex items-center w-[100%] h-[80vh] justify-center">
      ...
      <div>
        ...
        <div className="bg-[white] flex justify-center rounded w-[100%] m-auto">
          <input
            type="text"
            className="py-[12px] px-[8px] lg:w-[80%] md:w-[80%] outline-[#80bdff] text-[#495057] font-extrabold rounded-l-lg mt-[50px]"
            placeholder=""
            onChange={(e) => {
