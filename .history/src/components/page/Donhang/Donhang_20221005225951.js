...
function Donhang() {
  ...
  return (
    <div className="flex items-center lg:w-[40%] bg-[#F2F4F8] md:w-[90%] h-[80vh] justify-center m-auto">
      ...
      <div className="w-[80%] ">
        ...
        <div className="bg-[white] flex justify-center rounded w-[100%] m-auto mt-5">
          <input
            type="text"
            className="input-Number py-[12px] px-[8px] lg:w-[100%] md:w-[100%] outline-[#80bdff] text-[#495057] font-extrabold rounded-l-lg  shadow-sm shadow-[#979797]"
