  ...
  useEffect(() => {
    ...
    const checkValid = () => {
      if (number.length <= 0) {
        ...
        console.log(456);
        textAlert.style.display = "hidden";
      }
    };
    checkValid();
  });
  ...
  return (
    <div className="flex items-center w-[40%] h-[80vh] justify-center m-auto">
      ...
      <div className="w-[80%]">
       ...
       <div>
          <p className="text-Alert text-[#DC3545] font-bold  transition-all duration-75">
            Vui lòng nhập số điện thoại của bạn!
          </p>
          <p className="text-Alert2 text-[#DC3545] font-bold hidden transition-all duration-75">
