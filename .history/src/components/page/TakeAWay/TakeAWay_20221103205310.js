...
function TakeAWay() {
  ...
  return (
    <div className="take-A-Way relative">
      const {(ip, setIP)} = useContext(Context); const ipURL =
      `https://www.google.com/maps/embed?pb=${ip}`; const{" "}
      {(address, setAddress)} = useContext(Context); return (
      <div className="pt-[100px] w-[100%] relative flex lg:flex-row md:flex-col flex-col lg:items-start lg:justify-end md:justify-center md:items-center justify-center items-center">
        <div className="lg:w-[1140px] lg:h-[480px]  md:w-[720px] md:h-[240px] w-[400px] h-[240px]">
          ...
          <iframe
            ...
            frameborder="0"
          />
          <div className="w-[1140px] mt-[50px]">
            <div className="flex justify-between items-center">
              <div>
                <div>
                  <h1 className="font-bold">
                    Bạn chọn giao hàng đến địa chỉ này:
                  </h1>
              ...
              <div>
                <Link to="/thucdon">
                  <button className="font-bold text-white bg-[#E31837] px-10 py-5 rounded">
        ...
        <div className="flex justify-center items-center absolute top-[120px] left-[50%] translate-x-[-50%] z-[999]">
          <input
