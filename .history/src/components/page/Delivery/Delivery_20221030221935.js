  ...
  return (
    <div className="delivery">
      ...
      <div>
        <div>
            <div>
                <h1>Bạn chọn giao hàng đến địa chỉ này:</h1>
                <p></p>
            </div>
            <div>
                <h1>Ghi chú:</h1>
                <input type="text" className="text-[#6C757D] font-bold w-[100px] h-[40px] outline-[#80bdff] focus:shadow-md focus:shadow-[#80bdff]" placeholder="Nhập ghi chú" />
            </div>
        </div>
      </div>
    </div>
