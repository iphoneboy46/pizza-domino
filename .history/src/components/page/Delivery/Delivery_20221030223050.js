...
function Delivery() {
  return (
    <div className="delivery">
      ...
      <div className="m-auto mt-[50px] w-[1140px] ">
        <div className="flex justify-between items-center">
            <div>
                ...
                <div>
                    ...
                    <input type="text" className="text-[#6C757D] border-solid border-b-2 rounded-md px-2 font-bold w-[700px] h-[40px] outline-[#80bdff] focus:shadow-md focus:shadow-[#80bdff]" placeholder="Nhập ghi chú" />
                </div>
            </div>
            <div>
                <Link to="">
