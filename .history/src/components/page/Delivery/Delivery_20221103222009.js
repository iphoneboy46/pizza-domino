  ...
  return (
    <div id="map-content" className="delivery-page">
      <div className="map relative">
        ...
        <div className="flex justify-center items-center absolute top-[130px] left-[50%] translate-x-[-50%] z-[999] w-[800px]">
          <input
            className="lg:w-[90%] md:w-[70%] h-[40px] p-2 text-[#6C757D] font-bold border-[#ced4da] border-solid border-2 rounded-tl-md rounded-bl-md outline-[#80bdff] focus:shadow-md focus:shadow-[#80bdff]"
            type="text"
      ...
      <div className="m-auto my-[50px] lg:w-[1140px] md:w-[90%] ">
        <div className="flex lg:justify-between md:justify-between justify-center items-center lg:flex-row md:flex-row flex-col">
          <div className="w-[100%]">
            ...
            <div>
              ...
              <input
                type="text"
                className="text-[#6C757D] border-solid border-b-[1px] border-[#CED4DA] rounded-md px-2 font-bold w-[90%] h-[40px] outline-[#80bdff] focus:shadow-md focus:shadow-[#80bdff]"
