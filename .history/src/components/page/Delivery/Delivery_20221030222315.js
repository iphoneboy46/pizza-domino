      ...
      <div className="flex justify-center">
        <div>
            ...
            <div>
                ...
                <input type="text" className="text-[#6C757D] px-2 font-bold w-[800px] h-[40px] outline-[#80bdff] focus:shadow-md focus:shadow-[#80bdff]" placeholder="Nhập ghi chú" />
            </div>
            <div>
                <Link to="">
                    <button className="font-bold text-white"  >Giao hàng đến địa chỉ này</button>
                </Link>
            </div>
        </div>
      </div>
