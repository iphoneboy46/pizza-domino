    ...
    <div className="delivery">
      <div className="map relative">
        ...
        <div className="flex justify-center items-center">
          <input className="w-[800px] h-[50px] p-2 text-[#6C757D] font-bold border-[#ced4da] border-solid border-2 rounded-tl-md rounded-bl-md outline-[#80bdff] focus:shadow-md focus:shadow-[#80bdff]" type="text" placeholder="Vui lòng nhập địa chỉ nhận hàng" />
          <Link to="">
