...
function Delivery() {
 ...
 const handleScroll = () => {
  console.log("13546464")
    const pageDelivered = document.querySelector(".delivery-page");
    pageDelivered.scrollTop = 1000;
 }

  return (
    <div className="delivery-page h-[100vh] overflow-y-scroll">
      ...
      <button onClick={handleScroll}>scrollTop</button>
    </div>
  );
}
