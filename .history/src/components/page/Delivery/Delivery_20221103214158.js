    ...
    <div id="map-content" className="delivery-page">
      <div className="map relative">
        ...
        <div className="flex justify-center items-center absolute top-[130px] left-[50%] translate-x-[-50%] z-[999]">
          <input
            className="w-[800%] h-[40px] p-2 text-[#6C757D] font-bold border-[#ced4da] border-solid border-2 rounded-tl-md rounded-bl-md outline-[#80bdff] focus:shadow-md focus:shadow-[#80bdff]"
            type="text"
