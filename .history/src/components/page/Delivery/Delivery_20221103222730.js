        ...
        <div className="flex justify-between items-center lg:flex-row md:flex-row flex-col">
          <div className="w-[100%]">
            ...
            <div className="w-[70%]">
              ...
              <input
                type="text"
                className="text-[#6C757D] border-solid border-b-[1px] border-[#CED4DA] rounded-md px-2 font-bold lg:w-[100%] h-[40px] outline-[#80bdff] focus:shadow-md focus:shadow-[#80bdff]"
