  ...
  return (
    <div class="khuyen-mai pt-[180px]">
      <div class="flex m-auto w-[80%] mb-8">
        {khuyenmai1.map((km1) => {
          return <>
            <div class="w-[30%] lg:h-[425px] md:h-[500px] border-2 border-solid border-[#dfe4ea] rounded-3xl">
              <img class="w-[260px] h-[173px] p-2" src={km1.image} alt={km1.name} />
            </div>
            <div class="bg-content border-2 border-solid border-[#dfe4ea] rounded-3xl w-[80%] p-2">
      ...
      <div class="flex m-auto w-[80%] mb-8">
        {khuyenmai2.map((km1) => {
          return <>
            <div class="w-[280px] h-[676px] border-2 border-solid border-[#dfe4ea] rounded-3xl">
              <img class="w-[260px] h-[173px] p-2" src={km1.image} alt={km1.name} />
            </div>
            <div class="bg-content border-2 border-solid border-[#dfe4ea] rounded-3xl w-[830px] p-2">
              <div className="py-8 pl-8 pr-[180px] bg-white h-[100%] rounded-xl border-r-[10px] border-solid border-[#e31837]">
                <a href="" className="text-[#0078ae] text-4xl font-bold leading-[50px] no-underline hover:underline " >{km1.name}</a>
                <hr className="border-t-[4px] border-[#dfe4ea] w-16 mt-5 mb-3" />
                <p className="font-bold mb-3">{km1.description_1}</p>
      ...
      <div class="flex m-auto w-[80%] mb-8">
        {khuyenmai3.map((km3) => {
          return <>
            <div class="w-[280px] h-[425px] border-2 border-solid border-[#dfe4ea] rounded-3xl">
              <img class="w-[260px] h-[173px] p-2" src={km3.image} alt={km3.name} />
            </div>
            <div class="bg-content border-2 border-solid border-[#dfe4ea] rounded-3xl w-[830px] p-2">
              <div className="py-8 pl-8 pr-[180px] bg-white h-[100%] rounded-xl border-r-[10px] border-solid border-[#e31837]">
