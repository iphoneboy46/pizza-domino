  ...
  return (
    <div class="khuyen-mai pt-[180px]">
        ...
        {khuyenmai1.map((km1) => {
          return <>
            <div class="w-[30%] lg:h-[425px] md:h-[525px] border-2 border-solid border-[#dfe4ea] rounded-3xl">
              <img class="w-[260px] h-[173px] p-2 m-auto" src={km1.image} alt={km1.name} />
            </div>
      ...
      <div class="flex m-auto w-[80%] pb-10">
        {khuyenmai3.map((km3) => {
          return <>
            <div class="w-[30%] xl:h-[450px] lg:h-[425px]  md:h-[525px] border-2 border-solid border-[#dfe4ea] rounded-3xl">
              <img class="w-[260px] h-[173px] p-2 m-auto" src={km3.image} alt={km3.name} />
            </div>
            <div class="bg-content border-2 border-solid border-[#dfe4ea] rounded-3xl w-[70%] p-2">
              <div className="py-8 pl-8 lg:pr-[180px] md:pr-[0] bg-white h-[100%] rounded-xl border-r-[10px] border-solid border-[#e31837]">
