...
function Khuyenmai() {
  ...
  return (
    <div class="khuyen-mai pt-[180px] content">
      <Login />
      ...
      <div class="flex  lg:flex-row md:flex-row flex-col m-auto  lg:w-[50%] md:w-[80%] w-[100%] mb-8">
        {khuyenmai2.map((km1) => {
          return <>
            <div class=" lg:w-[30%] md:w-[30%] w-[100%] lg:h-[850px] md:h-[1100px] border-2 border-solid border-[#dfe4ea] rounded-3xl">
              <img class="w-[100%] h-[50%] p-5 m-auto" src={km1.image} alt={km1.name} />
            </div>
            <div class="bg-content border-2 border-solid border-[#dfe4ea] rounded-3xl  lg:w-[70%] md:w-[70%] w-[100%] p-2">
              <div className="py-8 pl-8 lg:pr-[180px] md:pr-[0] bg-white h-[100%] rounded-xl border-r-[10px] border-solid border-[#e31837]">
