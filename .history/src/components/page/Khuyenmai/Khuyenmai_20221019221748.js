...
function Khuyenmai() {
  ...
  return (
    <div class="khuyen-mai pt-[180px]">
      ...
      <Login />
      <div class="flex lg:flex-row md:flex-row flex-col m-auto lg:w-[50%] md:w-[80%] w-[100%] mb-8 p-2">
        {khuyenmai1.map((km1) => {
          return <>
            <div class="lg:w-[30%] md:w-[30%] w-[100%] lg:h-[525px] md:h-[525px] border-2 border-solid border-[#dfe4ea] rounded-3xl">
              <img class="w-[100%] h-[50%] p-5 m-auto" src={km1.image} alt={km1.name} />
            </div>
            <div class="bg-content border-2 border-solid border-[#dfe4ea] rounded-3xl  lg:w-[70%] md:w-[70%] w-[100%] p-2">
      ...
      <div class="flex  lg:flex-row md:flex-row flex-col m-auto  lg:w-[50%] md:w-[80%] w-[100%] mb-8 h-[auto]">
        {khuyenmai2.map((km1) => {
          return <>
            <div class=" lg:w-[30%] md:w-[30%] w-[100%] lg:h-[100%] md:h-[1100px] border-2 border-solid border-[#dfe4ea] rounded-3xl">
              <img class="w-[100%] h-[50%] p-5 m-auto" src={km1.image} alt={km1.name} />
            </div>
            <div class="bg-content border-2 border-solid border-[#dfe4ea] rounded-3xl  lg:w-[70%] md:w-[70%] w-[100%] p-2">
              <div className="py-8 pl-8 lg:pr-[180px] md:pr-[0] bg-white h-[100px] rounded-xl border-r-[10px] border-solid border-[#e31837]">
                <a href="" className="text-[#0078ae] text-4xl font-bold leading-[50px] no-underline hover:underline " >{km1.name}</a>
                <hr className="border-t-[4px] border-[#dfe4ea] w-16 mt-5 mb-3" />
                <p className="font-bold mb-3">{km1.description_1}</p>
      ...
      <div class="flex  lg:flex-row md:flex-row flex-col m-auto  lg:w-[50%] md:w-[80%] w-[100%] pb-10">
        {khuyenmai3.map((km3) => {
          return <>
            <div class=" lg:w-[30%] md:w-[30%] w-[100%] lg:h-[450px]  md:h-[525px] border-2 border-solid border-[#dfe4ea] rounded-3xl">
