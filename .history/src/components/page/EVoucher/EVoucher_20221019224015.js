...
function EVoucher() {
  return (
    <div className="EVoucher-content">
      <div className="p-2 solid border-2 border-[#717273] lg:w-[30%] md:w-[80%] w-[100%] h-[262px] m-auto rounded-[20px]">
        <div className="lg:w-[100%] md:w-[100%] h-[inherit-10px] bg-[#f2f4f8] m-auto rounded-[20px] px-[40px]">
