...
function EVoucher() {
  return (
    <div className="EVoucher-content">
      <div className="p-2 solid border-2 border-[#717273] lg:w-[30%] md:w-[80%] w-[100%] h-[65%] m-auto rounded-[20px]">
        <div className="lg:w-[100%] md:w-[100%] h-[90%] bg-[#f2f4f8] m-auto rounded-[20px] px-[40px]">
