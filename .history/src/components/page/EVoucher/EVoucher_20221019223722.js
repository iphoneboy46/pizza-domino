...
function EVoucher() {
  return (
    <div className="EVoucher-content">
      <div className="pt-2 solid border-2 border-[#717273] lg:w-[40%] md:w-[80%] w-[100%] h-[262px] m-auto rounded-[20px]">
        <div className="lg:w-[100%] md:w-[50%] h-[244px] bg-[#f2f4f8] m-auto rounded-[20px] px-[40px]">
