...
function OrderEdit() {
  ...
  const [checkedBaseEdit, setCheckedBaseEdit] = useState(cakeBase);
  console.log(checkedBaseEdit);
                ...
                >
                  <div className="flex items-center justify-between ">
                    <input
                      id={cake.name}
                      type="radio"
                      checked={checkedBaseEdit === cake.name}
                      onChange={() => {
                        setCheckedBaseEdit(cake.name);
                      }}
                    />
