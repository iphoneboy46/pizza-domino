...
function OrderEdit() {
  ...
  let total = pricePizza.reduce((acc, price) => {
  ...
  return (
    <div className="order-pizzaEdit lg:w-[800px] md:w-[90%] w-[90%]  h-[calc(100vh-20%)] bg-white flex lg:flex-row md:flex-row flex-col m-auto fixed -top-[100%] left-[50%] -translate-x-[50%] rounded-[6px] ease-in duration-500 z-[9999] lg:overflow-hidden md:overflow-hidden">
      <div className="flex lg:flex-row md:flex-row flex-col overflow-y-scroll">
        ...
        <div className="lg:w-[60%] md:w-[60%] w-[100%] h-[100%] flex flex-col">
          ...
          <div className="lg:flex md:flex hidden items-center justify-center h-[10%] p-3 solid border-t-2 border-[#dee2e6] shadow-[0px_0px_16px_rgb(0,42,61,16%)]">
            <div className="flex items-center">
              <button
                className="bg-[#dfe4ea] py-3 px-5 rounded-l-lg  hover:bg-[#c8d1db] active:bg-[#c0cad6] active:border-[#c0cad6]"
                onClick={handleMinus}
              >
              ...
              <button onClick={handlePlus} className="bg-[#dfe4ea] py-3 px-5 rounded-r-lg hover:bg-[#c8d1db] active:bg-[#c0cad6] active:border-[#c0cad6]">
      ...
      <div className="flex items-center justify-center flex-col h-[100%] p-5 solid border-t-2 border-[#dee2e6] shadow-[0px_0px_16px_rgb(0,42,61,16%)] overflow-hidden lg:hidden md:hidden">
