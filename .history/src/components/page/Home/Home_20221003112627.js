...
function Home() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="btn-buynow absolute left-[50%] text-[#0078AE] bg-white top-[0%] z-40 font-bold text-xl py-4 px-5 rounded-[50px] border-[#0078AE] solid border-2 translate-x-[-50%] translate-y-[-10%] hidden">
