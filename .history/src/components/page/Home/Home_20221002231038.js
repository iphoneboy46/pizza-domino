    ...
    <div className="overflow-hidden">
      ...
      <div className="bg-[#f2f4f8] pt-5 px-2">
        <div className="lg:w-[70%] md:w-[80%] m-auto">
          ...
          <div className="grid lg:grid-flow-col md:grid-flow-col-col lg:auto-cols-fr md:auto-cols-fr auto-cols- lg:gap-x-[30px] md:gap-x-[20px] mt-5 snap-x overflow-x-scroll">
