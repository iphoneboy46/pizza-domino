    ...
    <div className="overflow-hidden">
      ...
      <div className="bg-[#f2f4f8] pt-5 px-2">
        <div className="lg:w-[70%] md:w-[80%] m-auto">
          ...
          <div className="grid lg:grid-flow-col md:grid-flow-col lg:auto-cols-fr md:auto-cols-fr g:gap-x-[30px] md:gap-x-[20px] scroll-smooth gap-5 my-5 snap-x snap-mandatory grid-flow-col auto-cols-[80%] overflow-x-scroll pb-2">
