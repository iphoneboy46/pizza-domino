...
function Home() {
  ...
  return (
    <div className="overflow-hidden relative">
      ...
      <div className="phone-ring text-white text-xl lg:hidden md:hidden block">
      ...
      <div className="w-[50px] h-[50px] text-white text-[12px] p-6 font-bold fixed top-[70%] right-[10%] bg-[#00628F] rounded-[50%] flex items-center justify-center z-10">
        <div>
