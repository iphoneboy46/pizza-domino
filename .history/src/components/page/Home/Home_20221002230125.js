    ...
    <div className="overflow-hidden">
      ...
      <div className="bg-[#f2f4f8] pt-5 px-2">
        <div className="lg:w-[70%] md:w-[80%] m-auto">
          ...
          <div className="grid grid-flow-col lg:auto-cols-fr md:auto-cols-fr auto-cols-max lg:gap-x-[30px] md:gap-x-[20px] mt-5">
            {pizzaPremium.map((pizza, index) => {
              if (pizza.id <= 4) {
                return (
                  <div
                    key={index}
                    className="rounded-[10px] border-style: solid border-2 flex flex-col border-[#dfe4ea] bg-white w-[100%]"
                  >
                    <div className="w-[30%] h-[auto] mb-4 overflow-hidden rounded-t-lg">
                      <img
