      ...
      <div className="bg-[#f2f4f8] pt-5">
        <div className="lg:w-[70%] md:w-[80%] m-auto">
          <div className="flex items-center lg:flex-nowrap md:flex-nowrap flex-wrap">
            <h1 className="text-[#212529] font-extrabold text-2xl lg:mr-[100px] md:mr-[100px] lg:mb-0 md:mb-0 mb-5">
              Hôm Nay Ăn Gì?
            </h1>
            <Link
              className="text-[#212529] font-extrabold lg:mr-[100px] md:mr-[100px] mr-[20px]"
              to="/Khuyenmai"
            >
              Khuyến Mãi Mỗi Ngày
            </Link>
          ...
          <div className="grid grid-flow-col auto-cols-fr lg:gap-x-[30px] md:gap-x-[20px] mt-5">
