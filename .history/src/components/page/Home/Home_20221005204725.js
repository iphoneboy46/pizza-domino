  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="bg-[#f2f4f8] pt-5 px-2">
        <div className="lg:w-[50%] md:w-[80%] m-auto">
          ...
          <div className="grid lg:grid-flow-col md:grid-flow-col lg:auto-cols-fr md:auto-cols-fr g:gap-x-[30px] md:gap-x-[20px] scroll-smooth gap-5 mt-5 snap-x snap-mandatory grid-flow-col auto-cols-[80%] overflow-x-scroll ">
            {pizzaPremium.map((pizza, index) => {
              if (pizza.id <= 4) {
                return (
                  ...
                  >
                    <div className="w-[100%] h-[400px] mb-4 overflow-hidden rounded-t-lg snap-center">
                      <img
                    ...
                    <div className="p-2 h-[50%] lg:text-md md:text-sm text-align:center text-[#0078ae] font-semibold ">
                      <button
                        onClick={() => {
                          handlePizza(pizza);
                        }}
