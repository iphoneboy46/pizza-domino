...
function ThanhToan() {
  ...
  return (
    <div className="relative">
      <div className="alert-thanh-toan fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[30%] bg-[#F2F4F8] rounded-lg h-[300px] flex justify-center items-center flex-col px-10 duration-7000 ease-linear z-[999]">
        ...
        <div className="w-[100%] flex justify-center items-center">
          <button onClick={handleCloseThanhToan} className="px-[15%] py-3  bg-white text-center text-[#E31837] font-bold rounded-md">
            Quay lại
          </button>
