...
function ThanhToan() {
  ...
  return (
    <div className="relative">
      ...
      <div className="alert-added border-2 border-[#54bb10] w-[350px] py-2 px-1 text-center font-bold text-[#54bb10] bg-white rounded-md fixed left-[50%] -translate-x-[50%] z-20 hidden lg:top-[100px] md:top-[100px] top-[80px] ">
