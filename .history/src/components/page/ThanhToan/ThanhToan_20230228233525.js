            ...
            <div>
              ...
              <div>
                <div className="dat-hang flex items-center w-[100%] mb-5">
                  <input className="input-dat-hang" id="dathang" type="radio" value="Đặt hàng - Giao hàng ngay" onChange={handleChecked} />

                  <label for="dathang"></label>
                  <p className="ml-5">Đặt hàng - Giao hàng ngay</p>
                </div>
                <div className="giao-hang flex items-center w-[100%]">
                  <input className="input-giao-hang" id="giaohang" type="radio" value="Giao hàng - Nhận hàng hẹn giờ" onChange={handleChecked} />
