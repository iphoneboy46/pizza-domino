    ...
    <div className="relative">
      ...
      <div className="flex lg:flex-row lg:justify-between md:flex-col flex-col  h-[auto] w-[100%] ">
        <div className="pt-[80px] lg:w-[80%] md:w-[100%] w-[100%] overflow-hidden">
          ...
          <div className="lg:w-[60%] lg:flex-row md:flex-row md:w-[80%] w-[100%] flex-col  m-[auto] flex lg:justify-between md:justify-between lg:items-start md:items-start  items-center p-3">
