    ...
    <Formik initialValues={initialValues} validationSchema={validationSchema}>
      <div className="flex justify-between h-[100vh]">
        <div className="pt-[80px] w-[80%]">
          ...
          <div className="w-[70%] h-[100px] bg-yellowcustom m-[auto] flex justify-between items-start">
            <div>
              <h1>Thông tin người dùng</h1>
              <h2>Tên khách hàng*</h2>
              <FastField name="name" component={InputField} placeholder="Nhập tên khách hàng" label="Tên khách hàng*" />
