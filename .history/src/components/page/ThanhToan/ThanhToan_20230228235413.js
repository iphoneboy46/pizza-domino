            ...
            <div>
              ...
              <div>
                <div className="dat-thanh-toan flex items-center w-[100%] mb-5">
                  <input className="input-thanh-toan" id="dathang" type="radio" value="Đặt hàng - Giao hàng ngay" checked={checked === 1} onChange={()=>{
                    handleChecked(1)
                  }} />

                  <label for="dathang"></label>
                  <p className={checked === 1 ? "ml-5 text-[black] font-bold" : "text-[#6c757d] ml-5 font-bold"}>Đặt hàng - Giao hàng ngay</p>
                </div>
                <div className="dat-thanh-toan flex items-center w-[100%]">
                  <input className="input-thanh-toan" id="giaohang" type="radio" value="Giao hàng - Nhận hàng hẹn giờ" checked={checked === 2} onChange={()=>{
                    handleChecked(2)
                  }} />

                  <label for="giaohang"></label>
                  <p className={checked === 1 ? "ml-5 text-[black] font-bold" : "text-[#6c757d] ml-5 font-bold"}>Giao hàng - Nhận hàng hẹn giờ</p>
                </div>
              </div>
            </div>
          </div>
