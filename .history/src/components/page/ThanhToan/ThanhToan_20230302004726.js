      ...
      onSubmit={(values)=>{
        console.log(1231231);
          listProduct = {
            ...
            emailDienTu: values.emailDienTu || "",
     ...
     <Form>
        <div className="flex lg:flex-row lg:justify-between md:flex-col flex-col  h-[auto] w-[100%]">
          <div className="pt-[80px] lg:w-[80%] md:w-[100%] w-[100%] overflow-hidden">
            ...
            <button className="block m-auto font-bold text-xl uppercase bg-[#E31837] w-[400px] p-5 text-center text-white mb-5 rounded-xl" type="submit">Hoàn tất thanh toán</button>
          </div>
