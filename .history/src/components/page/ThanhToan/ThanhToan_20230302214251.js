...
function ThanhToan() {
  ...
  return (
    <div className="relative">
      <div className="fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[30%] bg-[#F2F4F8] z-50 h-[300px] flex justify-center items-center flex-col">
        <h1 className="text-xl font-bold mb-3" >Thông báo</h1>
        <h2 className="text-lg font-bold mb-3">
          Bạn đã chọn {takeAway ? takeAway + "tại cửa hàng" : ""}{" "}
          {Delivery ? Delivery +  " tại địa chỉ" : ""} {addressClient}
        </h2>

        <h1>Vui lòng chọn Tiếp tục để xác nhận thông tin, hoặc chọn Quay lại để thay đổi.</h1>
      </div>
