    ...
    <Formik initialValues={initialValues} validationSchema={validationSchema}>
      <div className="flex justify-between h-[auto] w-[100%]">
        <div className="pt-[80px] w-[80%] overflow-hidden">
                ...
                <div className="w-[100%] ml-5">
                  <div className="w-[100%]">
                    ...
                    <div className="flex w-[100%]">
                      ...
                      <div className="w-[20%] flex justify-center items-center font-bold bg-[#E31837] h-[41px] text-white cursor-pointer select-none">
                        Kiểm tra
                      </div>
                    </div>
                  </div>
          ...
          <div className="m-auto font-bold text-xl uppercase bg-[#E31837] w-[400px] p-5 text-center text-white mb-5 rounded-xl">Hoàn tất thanh toán</div>
        </div>

          <div className="w-[20%] pt-[80px] p-5">
                      ...
                      return(
                        <>
                          <div>
                            ...
                            <div className="w-[30%]">
                              <h6 className="font-bold text-xs text-graycustom">{menu.base}</h6>
                              <h6 className="font-bold text-xs">{menu.size}</h6>
                              <h6 className="font-bold text-xs">{menu.border9}</h6>
                              <h6 className="font-bold text-xs">{menu.border12}</h6>
                              <h6 className="font-bold text-xs">{menu.more9}</h6>
                              <h6 className="font-bold text-xs">{menu.more12}</h6>
                            </div>
                            <div className="w-[100px] h-[50px]">
                              <img className="w-[100%] h-[100%]" src={menu.image} alt="" />
                            </div>
                            </div>
                          </div>
                        </>
