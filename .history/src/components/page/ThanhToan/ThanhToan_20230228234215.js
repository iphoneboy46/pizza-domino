            ...
            <div>
              ...
              <div>
                <div className="dat-hang flex items-center w-[100%] mb-5">
                  <input className="input-dat-hang" id="dathang" type="radio" value="Đặt hàng - Giao hàng ngay" checked={checked === 1} onChange={()=>{
                    handleChecked(1)
                  }} />
                ...
                <div className="giao-hang flex items-center w-[100%]">
                  <input className="input-giao-hang" id="giaohang" type="radio" value="Giao hàng - Nhận hàng hẹn giờ" checked={checked === 2} onChange={()=>{
                    handleChecked(2)
                  }} />
