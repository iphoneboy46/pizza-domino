    ...
    <Formik initialValues={initialValues} validationSchema={validationSchema}>
      <div className="flex lg:justify-between md:flex-col flex-col  h-[auto] w-[100%]">
        <div className="pt-[80px] lg:w-[80%] md:w-[100%] w-[100%] overflow-hidden">
          ...
          <div className="lg:w-[60%] lg:flex-row md:flex-rw md:w-[80%] w-[100%] flex-col  m-[auto] flex lg:justify-between md:justify-between lg:items-start md:items-start justify-center items-center p-3">
