                        ...
                        <>
                          <div>
                            ...
                            <div className="w-[30%]">
                              ...
                              <h6 className="font-bold">{menu.size}</h6>
                              <h6 className="font-bold">{menu.border9}</h6>
                              <h6 className="font-bold">{menu.border12}</h6>
                              <h6 className="font-bold">{menu.more9}</h6>
                              <h6 className="font-bold">{menu.more12}</h6>
                            </div>
