...
function ThanhToan() {
  ...
  return (
    <div className="relative">
      ...
      <div className="alert-thanh-toan fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[20%] bg-[#F2F4F8] rounded-lg h-[300px] flex justify-center items-center flex-col px-10 duration-7000 ease-linear z-[900] ">
        <i
          onClick={handleCloseThanhToan}
          className="fa-solid fa-xmark absolute top-0 right-0 bg-[#E31837] text-white py-2 px-4 text-3xl w-[auto] rounded-tr-lg"
        ></i>
