  ...
  return (
    <div className="flex lg:flex-row lg:justify-between md:flex-col flex-col  h-[auto] w-[100%]">
      <div className="pt-[80px] lg:w-[80%] md:w-[100%] w-[100%] overflow-hidden">
        ...
        {(isName === false || name !== ""  && isPhone === false && isEmail === false) || (isName === false  && isPhone === false && isEmail === false && checkBox === true && isNameCompany === false && isAddress === false && isEmailDienTu === false && isMaSoThue === false) ? (
          <button
