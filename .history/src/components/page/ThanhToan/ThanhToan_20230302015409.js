...
function ThanhToan() {
  ...
  const [isNameCompany, setIsNameCompany] = useState("");
  ...
  useEffect(() => {
    ...
    if(phone.length < 1){
      setIsPhone(true);
    }else if(phone.type === " /^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/"){
      setIsPhone(true);
    }
    else{
      setIsPhone(false);
      ...
      <div className="pt-[80px] lg:w-[80%] md:w-[100%] w-[100%] overflow-hidden">
        ...
        <div className="lg:w-[60%] lg:flex-row md:flex-row md:w-[80%] w-[100%] flex-col  m-[auto] flex lg:justify-between md:justify-between lg:items-start md:items-start justify-center items-center p-3">
          <div className="flex-1 lg:mr-10 md:mr-10">
            ...
            />
            {isName && <span className="text-xs text-[red] font-bold">
            ...
            />
            {isPhone && <span className="text-xs text-[red] font-bold">
          ...
          {checkBox && (
            <div className="flex lg:justify-between lg:items-start lg:flex-row md:flex-col flex-col w-[100%]">
              <div className="w-[100%] lg:mr-5">
               ...
               {isNameCompany && <span className="text-xs text-[red] font-bold">
                ...
                />
                {isAddress && <span className="text-xs text-[red] font-bold">
                  Vui lòng nhập địa chỉ công tys
                </span>}
              </div>
              <div className="w-[100%] lg:ml-5">
                <div className="w-[100%]">
                  ...
                  <div className="flex w-[100%]">
                    <div className="w-[80%]">
                      ...
                      />
                      {isMaSoThue && <span className="text-xs text-[red] font-bold">
                ...
                />
                {isEmailDienTu && <span className="text-xs text-[red] font-bold">
