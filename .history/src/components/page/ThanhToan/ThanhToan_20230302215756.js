...
function ThanhToan() {
  ...
  return (
    <div className="relative">
      <div className="fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[30%] bg-[#F2F4F8] rounded-lg z-50 h-[300px] flex justify-center items-center flex-col px-10">
