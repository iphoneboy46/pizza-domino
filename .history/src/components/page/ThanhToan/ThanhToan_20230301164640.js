                      ...
                      return(
                        <>
                          <div>
                            ...
                            <div className="flex justify-between items-start">
                            <div>
                              <span className="font-bold">{menu.base}</span>
                              <span className="font-bold">{menu.size}</span>
                              <span className="font-bold">{menu.border9}</span>
                              <span className="font-bold">{menu.border12}</span>
                              <span className="font-bold">{menu.more9}</span>
                              <span className="font-bold">{menu.more12}</span>
                            </div>
