...
function ThanhToan() {
  ...
  const handleAdd = () => {
    const alert1 = document.querySelector(".alert-thanh-toan");
  ...
  const handleCloseThanhToan = () => {
    ...
    alert1.style.top = "-500%";
    document.body.style.overflow = "auto";
    content.classList.remove("modal");
  };

  const handleCloseThanhToan2 = () => {
    const alert2 = document.querySelector(".alert-thanh-toan-2");
    const content = document.querySelector(".content");

    alert2.style.top = "-500%";
    document.body.style.overflow = "auto";
    content.classList.remove("modal");
  };
  ...
  const handleXacNhan = () =>{
    const alert2 = document.querySelector(".alert-thanh-toan-2");
    const content = document.querySelector(".content");
    const alertThanhToanAdd = document.querySelector(".alert-added-thanh-toan")
    alert2.style.top = "-500%";
    document.body.style.overflow = "auto";
    content.classList.remove("modal");
  ...
  return (
    <div className="relative">
      ...
      <div className="alert-added-thanh-toan border-2 border-[#54bb10] w-[350px] py-2 px-1 text-center font-bold text-[#54bb10] bg-white rounded-md fixed left-[50%] -translate-x-[50%] z-20  lg:top-[100px] md:top-[100px] top-[200px] ">
      <i class="fa-solid fa-check"></i> Bạn đã đặt hàng thành công
     </div>  
      <div className="alert-thanh-toan fixed top-[-500%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[30%] bg-[#F2F4F8] rounded-lg h-[280px] flex justify-center items-center flex-col px-10 duration-7000 ease-linear z-[900] ">
        <i
        ...
        <div className="w-[100%] flex justify-center items-center">
          ...
          <button onClick={handleContinue} className="px-[15%] py-3  bg-[#E31837] text-center text-white font-bold rounded-md hover:bg-[#ca1a35]">
            Tiếp tục
          </button>
        </div>
      </div>
      <div className="alert-thanh-toan-2 fixed top-[-500%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[20%] bg-[#F2F4F8] rounded-lg h-[280px] flex justify-center items-center flex-col px-10 duration-7000 ease-linear z-[900] ">
        <i
        ...
        <button onClick={handleXacNhan} className="px-[15%] py-3  bg-[#E31837] text-center text-white font-bold rounded-md hover:bg-[#ca1a35]">
        Xác nhận
        </button>
      </div>
