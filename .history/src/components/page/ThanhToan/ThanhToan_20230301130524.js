  ...
  return (
    <Formik initialValues={initialValues} validationSchema={validationSchema}>
      <div className="flex justify-between h-[100vh] w-[100%]">
        <div className="pt-[80px] w-[50%] overflow-hidden">
          ...
          <div className="w-[80%] m-[auto] flex justify-between items-start p-5">
            ...
            <div className="flex-1">
              ...
              />
              <div>
                <div className="dat-thanh-toan flex items-center mb-5">
                  <input
                ...
                <div className="dat-thanh-toan flex items-center w-[100%] my-5">
                  <input
                    className="input-thanh-toan"
                    id="giaohang"
                    type="radio"
