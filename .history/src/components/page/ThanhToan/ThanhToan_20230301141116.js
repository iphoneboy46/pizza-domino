...
function ThanhToan() {
  ...
  const validationSchema = Yup.object().shape({
    ...
    emailDienTu: Yup.string().email().required("Vui lòng nhập Email nhận hóa đơn điện tử"),
      ...
      <div className="flex justify-between h-[auto] w-[100%]">
        <div className="pt-[80px] w-[80%] overflow-hidden">
          ...
          <div className="w-[60%] m-[auto] p-5">
            ...
            {checkBox && <div className="flex justify-between items-start w-[100%]">
              <div className="w-[100%] mr-5">
              ...
              <div className="w-[100%] ml-5">
                <div className="w-[100%]" >
                  ...
                  <div className="flex w-[100%]">
                    ...
                    <div className="w-[20%] flex justify-center items-center font-bold bg-[#E31837] h-[41px] text-white cursor-pointer select-none">Kiểm tra</div>
                  </div>
                </div>
