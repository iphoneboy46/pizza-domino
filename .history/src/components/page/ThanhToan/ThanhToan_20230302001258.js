...
function ThanhToan() {
  const { orderAddress, menuOrders, account,ghiChu,setGhiChu,listDonHang } = useContext(Context);
    ...
    <Formik initialValues={initialValues} validationSchema={validationSchema}>
      <div className="flex lg:flex-row lg:justify-between md:flex-col flex-col  h-[auto] w-[100%]">
        <div className="pt-[80px] lg:w-[80%] md:w-[100%] w-[100%] overflow-hidden">
          ...
          <div className="m-auto font-bold text-xl uppercase bg-[#E31837] w-[400px] p-5 text-center text-white mb-5 rounded-xl opacity-70 select-none">
            Hoàn tất thanh toán
          </div>
        </div>
