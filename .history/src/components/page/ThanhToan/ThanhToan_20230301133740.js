        ...
        <div className="pt-[80px] w-[80%] overflow-hidden">
          ...
          <div className="w-[60%] m-[auto] p-3">
            ...
            <div className="w-[100%] flex justify-between items-center p-5">
              <div className="w-[100%] mr-5">
                <div className="dat-thanh-toan flex items-center w-[100%] mb-3 border-b-[1px] border-[#CDCDCE] pb-5">
                  <input
                    className="input-thanh-toan"
                    id="atm"
                    type="radio"
          ...
          <div className="w-[60%] m-[auto] p-5">
            <div className="flex items-center">
              <input type="checkbox" /> <h1 className="text-xl font-bold">Xuất hóa đơn đỏ</h1>
            </div>
          </div>
        </div>
