...
function ThanhToan() {
  ...
  return (
    <Formik initialValues={initialValues} validationSchema={validationSchema}>
      <div className="flex lg:justify-between md:flex-col  h-[auto] w-[100%]">
        <div className="pt-[80px] lg:w-[80%] md:w-[100%] overflow-hidden">
          ...
          <div className="lg:w-[60%] md:w-[80%] m-[auto] flex justify-between items-start p-3">
          ...
          <div className="w-[20%] pt-[80px] p-5 border-l-2 border-[#DFE4EA]">
