        ...
        <div className="pt-[80px] w-[80%]">
          ...
          <div className="w-[60%] h-[100px] m-[auto] flex justify-between items-start p-5">
            <div>
              ...
              <label className="font-bold block mb-2" for="name">
                Tên khách hàng*
              </label>
              <FastField
                name="name"
              ...
              <label className="font-bold block mb-2" for="email">
                Email
              </label>
              <FastField
                name="email"
            ...
            <div>
              ...
              <div>
                <div className="dat-hang flex items-center w-[100%] mb-5">
                  <input className="input-dat-hang" id="dathang" type="radio" onChange={handleChecked} />

                  <label for="dathang"></label>
                  <p className="ml-5">Đặt hàng - Giao hàng ngay</p>
                </div>
                <div className="dat-hang flex items-center w-[100%]">
                  <input className="input-dat-hang" id="dathang" type="radio" />
