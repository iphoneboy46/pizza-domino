...
function ThanhToan() {
  ...
  return (
    <div className="relative">
      ...
      <div className="alert-1 fixed top-[-500%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[30%] bg-[#F2F4F8] rounded-lg z-50 h-[300px] flex justify-center items-center flex-col px-10 duration-7000 ease-linear z-[1000]">
        ...
        <div className="w-[100%] flex justify-center items-center">
          <button className="px-[15%] py-3  bg-white text-center text-[#E31837] font-bold rounded-md">Quay lại</button>
          <button className="px-[15%] py-3  bg-[#E31837] text-center text-white font-bold rounded-md hover:bg-[#ca1a35]">Tiếp tục</button>
        </div>
      </div>
