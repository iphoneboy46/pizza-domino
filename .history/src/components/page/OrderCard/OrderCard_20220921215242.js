          ...
          return (
            <div className="mb-3">
              ...
              <div className="flex items-center justify-between mt-3">
                <div className="w-[100px] bg-yellowcustom h-[100px]"></div>
                <div className="flex flex-col justify-between text-[14px] text-left w-[100%] bg-yellowcustom pl-10 font-bold text-[#717273]">
                  <span>{menu.base}</span>
                  <span>{menu.size}</span>
