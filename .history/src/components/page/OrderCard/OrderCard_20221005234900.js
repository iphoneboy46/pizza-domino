...
function OrderCard() {
  ...
  return (
    <div className="p-2">
      ...
      <div className="width-[100%] bg-[#E31837] py-2 text-[white] mt-2 text-center flex justify-center items-center rounded-lg">
        <span className="font-bold mr-5">HOÀN TẤT ĐƠN HÀNG</span>
        <span className="font-bold">{totalOrders}.000 ₫</span>
      </div>
    </div>
  );
