        ...
        {menuOrders.map((menu) => {
          return (
            <div className="mb-3 w-[100%]">
              <div className="flex justify-between">
                <div className="w-[10%]">
                  <span className="mr-2">{menu.quantity} x</span>
                </div>
                <div className="w-[50%]">
                  ...
                  <div className="flex justify-center mr-[150px] py-2 cursor-pointer select-none">
                    <span
                      onClick={() => {
                ...
                <div className="w-[40%]">
                    <span className="text-justify">{menu.price}.000 ₫</span>
                    <div className="w-[30px] h-[100%] rounded-xl">
                      <img
