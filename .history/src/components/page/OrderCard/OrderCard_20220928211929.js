...
function OrderCard() {
  const { menuOrders,totalQuantity,handlePizzaEdit,handleDelete } = useContext(Context);
          ...
          return (
            <div className="mb-3">
              <div className="flex justify-between items-center font-bold text-[13px]">
                ...
                <span>-</span>
                <span className="text-justify">{menu.price * menu.quantity}.000 ₫</span>
              </div>
              ...
              <div className="flex justify-center mr-[160px] py-2 cursor-pointer select-none">
                ...
                }} className="mr-5  text-[#0078ae] text-sm font-bold hover:text-[#004362]">Điều chỉnh</span>
                <span onClick={()=>{
                  handleDelete(menuOrders.id)
                }} className="text-[#0078ae] text-sm font-bold hover:text-[#004362]">Xóa</span>
              </div>
            </div>
          );
        })}
