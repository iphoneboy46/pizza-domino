...
function OrderCard() {
  ...
  return (
    <div className="p-2">
      ...
      <Link to="/cart"  className="width-[100%] bg-[#E31837] py-3 text-[white] mt-2 text-center flex justify-center items-center rounded-sm cursor-pointer">
        <span className="font-semibold mr-5">HOÀN TẤT ĐƠN HÀNG</span>
        <span className="font-bold">{totalConvert}.000 ₫</span>
      </Link>
    </div>
  );
