  ...
  return (
    <div className="w-[80%] m-auto pt-[100px] h-[100vh]">
      ...
      <div className="mb-5">
        {menuOrders.map((menu) => {
          return (
            <div className="lg:flex md:flex lg:justify-between md:justify-between lg:items-center md:items-center mb-5 lg:flex-row md:flex-row sm:flex sm:flex-wrap">
              <div className="lg:w-[20%] lg:h-[20%] md:w-[20%] md:h-[20%] lg:mr-[50px] md:mr-[50px] sm:w-[20%] sm:h-[20%]">
                <img
