  ...
  return (
    <div className="w-[80%] m-auto pt-[100px] h-[100vh]">
      ...
      <div className="mb-5">
        {menuOrders.map((menu) => {
          return (
            <div className="lg:flex md:flex lg:justify-between md:justify-between lg:items-center md:items-center mb-5 lg:flex-row md:flex-row sm:flex sm:flex-col sm:justify-between">
            <div className="lg:block md:block sm:flex">
                <div className="lg:w-[20%] lg:h-[20%] md:w-[20%] md:h-[20%] lg:mr-[50px] md:mr-[50px] sm:w-[50%] sm:h-[50%] sm:flex">
                  <img
                    className="w-[50%] h-[100%] rounded-xl mb-5"
                    src={menu.image}
                    alt={menu.name}
                  />
                </div>
                <div className="lg:w-[40%] md:w-[40%] sm:w-[50%]">
              ...
              <div className="lg:w-[40%] md:w-[40%] sm:w-[100%]">
      ...
      <div className="flex flex-col items-end justify-between">
        ...
        <div className="bg-[red] w-[40%] text-center mt-5 font-bold text-[white] p-3 cursor-pointer">
