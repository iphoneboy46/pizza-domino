...
function Giohang() {
  ...
  return (
    <div className="w-[50%] m-auto pt-[100px] h-[auto]">
      ...
      {menuOrders.length > 0 ? (
        <>
          ...
          <div className="mb-5 h-[60%] lg:overflow-y-scroll md:overflow-y-scroll overflow-y-scroll border-solid border-2 bottom-1 border-[#DFE4EA]">
            {menuOrders.map((menu) => {
              return (
                
                <div className="lg:flex md:flex lg:justify-between lg:items-start md:justify-between md:items-start mb-5 lg:flex-row md:flex-row lg:flex-nowrap md:flex-nowrap flex flex-wrap">
                  <div className="lg:w-[25%] lg:h-[25%] md:w-[20%] md:h-[20%] lg:mr-[50px] md:mr-[50px] w-[50%] h-[100%] mr-5">
                    <img
                  ...
                  <div className="lg:w-[40%] md:w-[40%] w-[40%]">
                    ...
                    <p className="font-bold text-[#717273] my-1 text-sm">{menu.size}</p>
                    <p className="font-bold text-[#717273] my-1 text-sm">{menu.base}</p>
                    ...
                    <div className="flex justify-between items-start mb-[40px]">
                      <div className="w-[100%]">
                        <p className="font-bold">{
                          menu.totalP > 1000 ? menu.totalP.toFixed().split("").slice(0, 1) + "." + menu.totalP.toFixed().split("").slice(1).join("") +".000 ₫" : menu.totalP + ".000 ₫"
        ...
        <div className="flex flex-col items-center">
          ...
          <Link
            className="lg:w-[15%] md:w[30%] w-[60%]  bg-[#e31837] p-3 m-auto text-center text-white font-bold rounded-md"
            to="/thucdon"
          >
            Tiếp tục chọn món
          </Link>
