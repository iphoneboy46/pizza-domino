...
function Giohang() {
  ...
  return (
    <div className="lg:w-[50%] md:w-[80%] w-[100%] m-auto pt-[100px] h-[auto] p-2">
       <div className="alert-added border-2 border-[#54bb10] w-[350px] py-2 px-1 text-center font-bold text-[#54bb10] bg-white rounded-md fixed left-[50%] -translate-x-[50%] z-20 hidden top-2 ">
