        ...
        menuOrders.map((menuOrder) => {
          return menuOrder.id === id
            ? {
                ...
                price: (menuOrder.price = 189 * menuOrder.quantity),
              }
            : menuOrder;
        })
      );
    ...
    <div className="w-[80%] m-auto pt-[100px] h-[100vh]">
      ...
      {menuOrders.length > 0 ? (
                ...
                <div className="lg:flex md:flex lg:justify-between md:justify-between lg:items-center md:items-center mb-5 lg:flex-row md:flex-row lg:flex-nowrap md:flex-nowrap flex flex-wrap">
                  ...
                  <div className="lg:w-[40%] md:w-[40%] w-[100%] ">
                    <div className="flex justify-between items-start mb-[40px]">
                      <div className="w-[100%]">
                        <p className="font-bold">{menu.price}.000 ₫</p>
                      </div>
        ...
        <div className="flex flex-col items-center">
          <img
            className="lg:w-[40%] md:w[60%] w-[80%] h-[40%] m-auto"
            src="https://dominos.vn/img/illustration/empty-cart.svg"
            alt=""
          />
          <h1 className="font-bold text-center p-4 w-[80%] m-auto">
          ...
          <Link className="w-[15%] bg-[#e31837] p-3 m-auto text-center text-white font-bold rounded-md" to="/thucdon">Tiếp tục chọn món</Link>
        </div>
      )}
    </div>
  );
