    ...
    <div className="lg:w-[50%] md:w-[80%] w-[100%] m-auto pt-[100px] h-[auto] p-2">
      ...
      {menuOrders.length > 0 ? (
            ...
            {menuOrders.map((menu) => {
              return (
                ...
                <div className="lg:flex md:flex lg:justify-between lg:items-start md:justify-between md:items-start mb-5 lg:flex-row md:flex-row lg:flex-nowrap md:flex-nowrap flex flex-wrap border-b-[1px]  border-[#DFE4EA]">
                  <div className="lg:w-[25%] lg:h-[25%] md:w-[20%] md:h-[20%] lg:mr-[50px] md:mr-[50px] w-[30%] h-[100%] mr-5">
                    <img
        ...
        <div className="flex flex-col items-center">
          <img
            className="lg:w-[40%] md:w[60%] w-[100%] h-[100vh] m-auto"
          ...
          <Link
            className="lg:w-[20%] md:w[30%] w-[60%]  bg-[#e31837] p-3 m-auto text-center text-white font-bold rounded-md"
            to="/thucdon"
          >
            Tiếp tục chọn món
          </Link>
