          ...
          if (menuOrder.quantity <= 1) {
            ...
            return menuOrder.id === id
              ? {
                  ...
                  price: menuOrder.price === 189 ? menuOrder.price = 189 : menuOrder.price - 189
                }
              : menuOrder;
          }
        })
  ...
  return (
    <div className="w-[80%] m-auto pt-[100px] h-[100vh]">
      ...
      <div className="flex flex-col items-end justify-between">
        ...
        <div className="bg-[red] lg:w-[40%] md:w-[40%] w-[100%] text-center mt-5 font-bold text-[white] p-3 cursor-pointer  mb-[50px]">
