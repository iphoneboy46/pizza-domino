...
function Giohang() {
  ...
  useEffect(() => {
    let totalTong = menuOrders.map((menu)=>{
      return menu.totalP
    })
    console.log(totalTong);

   setTotalNumberCon(totalTong)
    if (totalTong > 1000) {
      const numberFirst = totalTong.toFixed().split("").slice(0, 1);
      const numberLast = totalTong.toFixed().split("").slice(1).join("");
                ...
                <div className="lg:flex md:flex lg:justify-between md:justify-between lg:items-center md:items-center mb-5 lg:flex-row md:flex-row lg:flex-nowrap md:flex-nowrap flex flex-wrap">
                  ...
                  <div className="lg:w-[40%] md:w-[40%] w-[100%] ">
                    <div className="flex justify-between items-start mb-[40px]">
                      <div className="w-[100%]">
                        <p className="font-bold">{menu.totalP}</p>
                      </div>
