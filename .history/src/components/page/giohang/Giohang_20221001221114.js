          ...
          return (
            ...
            <div className="flex justify-between items-center mb-5">
              ...
              <div className="w-[40%]">
                ...
                <p className="font-bold text-[#717273] my-3">{menu.border9}</p>
                <p className="font-bold text-[#717273] my-3">{menu.border12}</p>
                <p className="font-bold text-[#717273] my-3">{menu.more9}</p>
                <p className="font-bold text-[#717273] my-3">{menu.more12}</p>
