...
function Giohang() {
        ...
        menuOrders.map((menuOrder) => {
          ...
          return menuOrder.name === name
            ? {
                ...
                totalP: setTotalNumberCon(totalNumberCon),
              }
            : menuOrder;
        })
      );
  ...
  const [totalNumberCon, setTotalNumberCon] = useState(()=>{
    return menuOrders.map((menuOrder)=>{
      return menuOrder.price * menuOrder.quantity
    })
  });
