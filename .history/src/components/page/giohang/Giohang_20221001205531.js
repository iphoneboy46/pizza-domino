          ...
          return (
            <>
              ...
              <div className="w-[40%]">
                ...
                <div className="flex justify-end cursor-pointer select-none w-[100%] mb-5">
                <button className="w-[100%] btn-khuyenMai text-[#0078ae] text-center font-bold text-lg hover:text-[#004362]">
