                  ...
                  <div className="lg:w-[40%] md:w-[40%] w-[100%] ">
                    <div className="flex justify-between items-start mb-[40px]">
                      ...
                      <div className="flex items-center">
                        <button
                          className="bg-[#dfe4ea] py-3 px-4 flex justify-center items-center rounded-l-lg  hover:bg-[#c8d1db] active:bg-[#c0cad6] active:border-[#c0cad6]"
                          onClick={() => {
                        ...
                        <div className="bg-[#e9ecef] flex justify-center items-center py-3 px-4 text-center">
                          {menu.quantity}
                        </div>
                        <button
                          onClick={() => {
