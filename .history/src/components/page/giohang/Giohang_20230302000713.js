      ...
      {menuOrders.length > 0 ? (
        <>
          ...
          <div className="flex flex-col items-end justify-between lg:relative md:relative fixed bottom-0 w-[100%] bg-white left-0 right-0 z-10 p-3">
            ...
            <Link to="/thanhtoan" className="bg-[#E31837] lg:w-[40%] md:w-[100%] w-[100%] text-center mt-5 font-bold text-[white] p-3 cursor-pointer ">
