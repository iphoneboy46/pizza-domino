            ...
            {menuOrders.map((menu) => {
              return (
                <div className="lg:flex md:flex lg:justify-between lg:items-start md:justify-between md:items-start mb-5 lg:flex-row md:flex-row lg:flex-nowrap md:flex-nowrap flex flex-wrap border-b-[1px]  border-[#DFE4EA]">
                  <div className="lg:w-[25%] lg:h-[25%] md:w-[20%] md:h-[20%] lg:mr-[50px] md:mr-[50px] w-[30%] h-[100%] lg:mr-5">
                    <img
                  ...
                  <div className="lg:w-[40%] md:w-[40%] w-[100%] ">
                    <div className="flex justify-between items-start mb-[40px]">
                      ...
                      <div className="flex items-center">
                        <button
                          className="bg-[#dfe4ea] lg:w-[50px] md:w-[40px] py-4 flex justify-center items-center rounded-l-lg  hover:bg-[#c8d1db] active:bg-[#c0cad6] active:border-[#c0cad6]"
                          onClick={() => {
                        ...
                        <button
                          ...
                          className="bg-[#dfe4ea] py-4  rounded-r-lg lg:w-[50px] md:w-[40px] hover:bg-[#c8d1db] active:bg-[#c0cad6] active:border-[#c0cad6] flex justify-center items-center"
                        >
