...
function App() {
  return (
    <div className="App relative">
      <BrowserRouter>
        <Header />
        <div className="menu-Mobile absolute top-[100px] h-[100vh] left-[-100%] bottom-0 right-0 bg-[#004666] z-[3000] w-[100%] py-10 transition-all duration-500 linear lg:hidden md:hidden sm:block">
          <ul className="text-white font-semibold uppercase flex flex-col justify-between px-2 h-[30%]">
            <li>
