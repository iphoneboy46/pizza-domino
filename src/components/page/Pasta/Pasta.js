...
function Pasta() {
  const { pastas,  handleSideDishes } = useContext(Context);

  return (
    <div className="bg-[#f2f4f8] h-[800px] overflow-y-scroll lg:px-[80px] md:px-[10px] px-0 ">
          ...
          {pastas.map((pasta, index) => {
            return (
              ...
              >
                ...
                <div className="p-2 lg:h-[50px] md:h-[50%] h-[50%] text-[#0078ae] text-center font-semibold">
                  <button
                    onClick={() => {
